...
CREATE TABLE `COMPANY` (
  ...
  KEY `FK6372C85D44E2B63D` (`TAX_LIABILITY_ACCOUNT_ID`),
  KEY `FK6372C85D58A46CF1` (`CASH_DISCOUNTS_GIVEN`),
  KEY `FK6372C85D81CA4B73` (`CASH_DISCOUNTS_TAKEN`),
  ...
  CONSTRAINT `FK6372C85D44E2B63D` FOREIGN KEY (`TAX_LIABILITY_ACCOUNT_ID`) REFERENCES `ACCOUNT` (`ID`),
  CONSTRAINT `FK6372C85D58A46CF1` FOREIGN KEY (`CASH_DISCOUNTS_GIVEN`) REFERENCES `ACCOUNT` (`ID`),
  CONSTRAINT `FK6372C85D81CA4B73` FOREIGN KEY (`CASH_DISCOUNTS_TAKEN`) REFERENCES `ACCOUNT` (`ID`),
...
CREATE TABLE `SALES_PERSON` (
  ...
  `COUNTRY` varchar(255) DEFAULT NULL,
  `IS_SELECTED` bit(1)  DEFAULT FALSE,
  `CREATED_BY` bigint(20) NOT NULL,
...
INSERT INTO `SERVER_COMPANY` VALUES (1,'Rajesh','2011-08-12 18:01:41',1,'','\0');
...
CREATE TABLE `VENDOR` (
  ...
  `TAX_ID` varchar(255),
  `IS_TRACKPAYMENTS_FOR_1099` bit(1),
  `IS_TDSAPPLICABLE` bit(1),  
  PRIMARY KEY (`ID`),
...
-- Dump completed on 2011-08-12 18:02:18