	    ...
	    <div id="commanContainer">
		 ...
		 <form class="accounterform" id = "emailActivationForm" action="/main/emailActivation" method="post">
			...
			<div>
			  ...
			  <input id = "emailidBox" type="text" name="email" />
			</div>
			<div class="reset-button">
			   <input type="submit" tabindex="3" value="<i18n:i18n msg='activation'/>" name="resend" class="allviews-common-button" id="submitButton" />
			</div>
		 </form>
