...
var _20=isc.isA.WebService(_3)&&this.$du(_2.spoofResponses,this.spoofResponses);if(_20){_17.spoofedResponse=_3.getSampleResponse(_4.name);this.logInfo("Using spoofed response:\n"+_17.spoofedResponse,"xmlBinding")}}
if(this.logIsDebugEnabled("xmlBinding")){this.logDebug("serviceInputs are: "+this.echo(_17),"xmlBinding")}
return _17}
...
,isc.A.$377=function(_1,_2,_3){var _4=_3.$374,_5=this.getOperationBinding(_4).recordXPath||this.recordXPath;if(_1.$38c&&this.logIsDebugEnabled("xmlBinding")){this.logDebug("Raw response data: "+isc.Comm.serialize(_2,true),"xmlBinding")}
...
_3.parentSchemaNamespace=_16}else if(_6!=null){if(_6.multiple){_5.append("\r",_4,_13,"\r");for(var i=0;i<_15.length;i++){_5.append(this.$38g(_6.childTagName,_6,_15[i],_10,_3),"\r",_4)}
...
return _10}
,isc.A.$38b=function(_1,_2,_3,_4,_5){if(!_2)_2={};if(_4!=null&&_5!=null){_2.httpResponseCode=_4.httpResponseCode;_2.transactionNum=_4.transactionNum;_2.clientContext=_5.clientContext}
...
if(_4.downloadResult==null)_4.downloadResult=true;if(_4.downloadToNewWindow==null)_4.downloadToNewWindow=_1=="viewFile"?true:false;if(_4.showPrompt==null)_4.showPrompt=false;var _7=this.filterPrimaryKeyFields(isc.clone(_2));_7.download_fieldname=_3;_4.download_filename=_2[_3+"_filename"];_7.download_filename=_4.download_filename;return this.performDSOperation(_1,_7,null,_4)}
...
,isc.A.performDSOperation=function(_1,_2,_3,_4){if(isc.$cv)arguments.$cw=this;var _5=isc.addProperties({operationType:_1,dataSource:this.ID,data:_2,callback:_3,requestId:this.$625()},_4);if(_5.sortBy!=null){var _6=this.getField(_5.sortBy.charAt(0)=="-"?_5.sortBy.substring(1):_5.sortBy);if(_6&&_6.canSortClientOnly)_5.sortBy=null}
...
);isc.evalBoundary;isc.B.push(isc.A.getPluralTitle=function(){return this.pluralTitle||(this.getTitle()+"s")}
...
_4.data=_7;break;case"remove":case"delete":var _14=this.findByKeys(_1.data,_2);if(_14==-1){this.logWarn("clientOnly remove operation: Unable to find record matching criteria:"+this.echo(_1.data))}else{_2.removeAt(_14);_4.data=isc.addProperties({},_1.data)}
break;case"add":case"insert":var _15=isc.addProperties({},_1.data);_15=this.applySequenceFields(_15);_2.add(_15);_4.data=isc.addProperties({},_15);break;case"replace":case"update":var _14=this.findByKeys(_1.data,_2);if(_14==-1){this.logWarn("clientOnly update operation: Unable to find record matching criteria:"+this.echo(_1.data))}else{var _15=_2[_14];isc.addProperties(_15,_1.data);_4.data=isc.addProperties({},_15)}
...
return 1}
return _7}
);isc.B._maxIndex=isc.C+138;isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$628=0;isc.B.push(isc.A.addSearchOperator=function(_1){if(!_1||!_1.ID){isc.logWarn("Attempted to add null search operator, or operator with no ID");return}
...
);isc.B._maxIndex=isc.C+3;isc.$571=function(){var _1=function(_57,_58,_59,_60,_61,_62){var _2;if(!_60.criteria){_60.criteria=[]}
...
);isc.B._maxIndex=isc.C+1;isc.ClassFactory.defineClass("RPCResponse");isc.A=isc.RPCResponse;isc.A.errorCodes={STATUS_SUCCESS:0,STATUS_FAILURE:-1,STATUS_VALIDATION_ERROR:-4,STATUS_LOGIN_INCORRECT:-5,STATUS_MAX_LOGIN_ATTEMPTS_EXCEEDED:-6,STATUS_LOGIN_REQUIRED:-7,STATUS_LOGIN_SUCCESS:-8,STATUS_TRANSPORT_ERROR:-90,STATUS_UNKNOWN_HOST_ERROR:-91,STATUS_CONNECTION_RESET_ERROR:-92,STATUS_SERVER_TIMEOUT:-100};isc.RPCResponse.addClassProperties(isc.RPCResponse.errorCodes)
...
delete _4.$66o;delete _4.abortCallbacks;_4.receiveTime=isc.timeStamp();_4.changed();isc.RPCManager.$410.remove(_1);this.logInfo("transaction "+_1+" arrived after "+(_4.receiveTime-_4.sendTime)+"ms");if(_3)_4.$ch=_3;if(_2==null){this.logFatal("No results for transaction "+_1);isc.Comm.closeOperationPromptWindow(_4);return false}
...
);isc.B._maxIndex=isc.C+67;isc.RPCManager.rpc_logMessage=isc.RPCManager.logMessage;isc.RPCManager.logMessage=function(_1,_2,_3,_4){if(this.logIsEnabledFor(_1,_3)){if(isc.isA.String(_2)&&_2.length>this.maxLogMessageLength&&!this.logIsEnabledFor(_1,"RPCManagerResponse"))
...
if(this.$395==_1&&this.$392==_2&&this.$393==_3)return;var _5;if(_4)_5=_4.getField(_1);if(_5&&_5.displayField)_1=_5.displayField;this.$395=_1;this.$392=_2;this.$393=_3;this.$45g=_4;if(this.isPaged()||!this.shouldUseClientSorting()){this.$39x=(this.$392?"":"-")+this.$395}
this.$391()}
...
var _5=this.getFileItemForm();if(_5&&_5.isDrawn()){this.updateFileItemForm();if(!this.validate())return false;return _5.saveData(_1,_2,_3)}
var _6=this.getSaveOperationType(_2);this.$40c=_1;_1=this.getID()+".$49z(dsRequest, dsResponse, data)";_2=this.buildRequest(_2,_6,_1);_2.oldValues=this.$10s;var _7=false;if(this.submitParamsOnly)_2.useSimpleHttp=true;if(isc.DynamicForm&&isc.isA.DynamicForm(this)){if(this.$66g){_2.actionURL=this.action;_2.target=this.target?this.target:window;_7=true}
if(this.method!=isc.DynamicForm.getInstanceProperty("method")){_2.httpMethod=this.method}}
if(!this.validate())return false
var _8=this.getValues();if((isc.DynamicForm&&isc.isA.DynamicForm(this)&&this.isMultipart())||this.canSubmit||_7)
{return this.submitEditorValues(_8,_2.operation,_2.callback,_2)}else{return this.saveEditorValues(_8,_2.operation,_2.callback,_2)}},updateFileItemForm:function(){var _1=this.getFileItemForm();if(_1==null)return;var _2=_1.getValues(),_3=this.getValues(),_4=_1.getItem(0).getFieldName();for(var _5 in _2){if(_5==_4)continue;_1.setValue(_5,null)}
...
,isc.A.setData=function(_1){if(_1==null)_1=[];if(_1.dataSource)this.setDataSource(_1.dataSource);if(this.list!=null){this.list.setData(_1);this.form.clearValues()}else{isc.addProperties(this.listDefaults,{data:_1})}}
...
,isc.A.recordClick=function(_1){if(this.inlineEdit)return;var _2=this;var _3=function(_4){if(_4){_2.currentRecord=_1;if(!_2.inlineEdit)_2.form.editRecord(_1);_2.form.setValues(isc.addProperties({},_2.list.getSelectedRecord()))}}
...
,isc.A.newRecord=function(){if(this.inlineEdit)return this.list.startEditingNew();var _1=this;var _2=function(_3){if(_3){_1.list.deselectAllRecords();_1.showForm();_1.form.editNewRecord()}}
...
ignore:{type:"boolean"},
canSortClientOnly:{type:"boolean"}
}
})
isc.DataSource.create({
ID:"Validator",
...
this.$31u(_3)}
,isc.A.$31u=function(_1){if(this.mainEditor)this.mainEditor.setValues(_1);else this.mainEditorValues=_1;var _2=_1.fields;if(!isc.isAn.Array(_2))_2=isc.getValues(_1.fields);if(this.fieldEditor)this.fieldEditor.setData(_2);this.show()}
,isc.A.save=function(){var _1=this.dsClass||"DataSource",_2=isc.addProperties({},this.mainEditor?this.mainEditor.getValues():this.mainEditorValues,{fields:this.fieldEditor.getData()});if(_2.serverType=="sql"||_2.serverType=="hibernate"){if(!_2.fields.getProperty("primaryKey").or()){isc.warn("SQL / Hibernate DataSources must have a field marked as the primary key");return}}
this.doneEditing(_2)}
...
,isc.A.initWidget=function(){this.Super('initWidget',arguments);this.addAutoChildren(["mainStack","fieldLayout","instructions","mainEditor","saveButton"]);this.addAutoChild("fieldEditor",{showMoreButton:this.showMoreButton,moreButtonProperties:isc.addProperties(this.moreButtonDefaults,this.moreButtonProperties)});this.moreButton=this.fieldEditor.moreButton;this.fieldLayout.addMembers([this.fieldEditor,this.saveButton]);var _1=this.mainStack;_1.addSections([isc.addProperties(this.instructionsSectionDefaults,this.instructionsSectionProperties,{items:[this.instructions]})]);_1.addSections([isc.addProperties(this.mainSectionDefaults,this.mainSectionProperties,{items:[this.mainEditor]})]);if(this.showMainEditor==false)_1.hideSection(1);_1.addSections([isc.addProperties(this.fieldSectionDefaults,this.fieldSectionProperties,{items:[this.fieldLayout]})])}
