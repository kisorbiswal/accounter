...
/*
  ...
  Version 7.0RC_2/LGPL Development Only (2009-05-19)
...
_1=_1||this.data;_2=_2||this.idField;_3=_3||this.parentIdField;_4=_4||this.rootValue;var _7=[];_7.addList(_1);for(var i=0;i<_7.length;i++){var _9=_7[i];if(_9==null)continue;var _10=_9[_3],_11=_10!=null?_7.find(_2,_10):null,_12=[];while(_11!=null){if(_11)_12.add(_11);_10=_11[_3];_11=_10!=null?_7.find(_2,_10):null}
...
var _15=_6[_2.name];var _16;if(_2.getCellStyle)
_16=_2.getCellStyle(_15,_2,_6,this);else _16=(this.getCellStyle(_15,_2,_6,this)||this.cellStyle);var _17=" style='";if(this.clipValues)_17+="overflow:hidden;";_17+="text-align:"+this.valueAlign;if(this.getCellCSSText){var _18=this.getCellCSSText(_15,_2,_6,this);if(_18!=null)_17+=";"+_18}
...
if(_2){if(_2.userFormula)_3=this.getFormulaFieldValue(_2,_1);if(_2.userSummary)_3=this.getSummaryFieldValue(_2,_1)}
...
,isc.A.setFields=function(_1){this.completeFields=this.bindToDataSource(_1);if(!this.completeFields)return;this.fields=isc.clone(this.completeFields);for(var i=0;i<this.completeFields.length;i++){var _3=this.completeFields.get(i);if(!this.fieldShouldBeVisible(_3)||_3.visible==false)this.fields.remove(_3)}}
...
_17.append("<TBODY>")}
var _32=this.cellHeight,_33=(this.wrapCells?"":"<NOBR>"),_34=(this.wrapCells?"":"</NOBR>");var _35=0;if(isc.Browser.isDOM){var _36=this.$28v(_32);var _37=[];_37[0]="<TD";_37[3]=" ALIGN=";_37[17]=this.fastCellUpdates?"' ":"' CLASS=";if(!_5&&this.getCellElementId)_37[19]=" ID=";_37[23]=">"+_33;_37[30]=_34+(_36?"</DIV></TD>":"</TD>");var _38=1,_39=2,_40=4,_41=5,_42=6,_43=7,_44=10,_45=11,_46=18,_47=20,_48=21,_49=24;var _50="<TR>",_51="</TR>",_52=" HEIGHT=",_53=" VALIGN=";if(isc.screenReader)_50="<TR tabIndex=-1>";var _54=[],_55=0,_56=[];var _57=this.selectionAppearance=="checkbox",_58=!_57?0:this.isRTL()?_15-1:0;var _59=" COLSPAN="+(_15-1)+" STYLE='"+(this.fixedRowHeights?"padding-top:0px;padding-bottom:0px;":"");var _60=" COLSPAN="+_15+" STYLE='"+(this.fixedRowHeights?"padding-top:0px;padding-bottom:0px;":"");this.$50d(_13,_14,_25,_30,_36);if(this.isPrinting&&(!this.$568||_2==0)){_17.append(this.grid.getPrintHeaders(_13,_14))}
for(var _61=_2;_61<_3;_61++){var _62=(!_5&&this.$28c==_61);var _63=this.getCellRecord(_61);var _64=_62||this.$282(_61,_63);if(!_5&&this.getRowElementId){_17.append("<TR",(isc.screenReader?" tabIndex=-1":null)," ID=",this.getRowElementId(_61,_61-_2),">")}else{_17.append(_50)}
if(this.fixedRowHeights||_36){var _65=_62?this.$28f:(this.getRowHeight!=null?this.getRowHeight(_63,_61):_32),_66=_62||(this.shouldFixRowHeight==null||this.shouldFixRowHeight(_63,_61)!=false);if(_66){_37[_38]=_52;_37[_39]=_65-_29;_37[_44]=null}else{_37[_38]=null;_37[_39]=null;_37[_44]=this.$281(_63,_61)}
if(_36){_37[_48]=">"+this.$27s+this.$283(_65,_63,_61,_62)}}
for(_1=_13;_1<_14;_1++){if(_64&&_63&&_63.$52e&&_57&&_1==_58)_1++;var _67=_18[_1],_68=_63;if(_68==null)_68=this.getCellRecord(_61,_1);if(_54[_1]>0){_67.$28w[_61]=_56[_1];_54[_1]--;if(_54[_1]==0){_55--;_56[_1]=null}
continue}
_37[_40]=this.getCellAlign(_63,_67,_61,_1);var _69=this.getCellVAlign(_63,_67,_61,_1);if(_69!=null){_37[_41]=_53
_37[_42]=_69}
if(_64&&(!_57||_1!=_58))
{_35++;_37[_43]=(_63&&_63.$52e)?_60:_59;if(_36){_37[_48+1]=this.$ob}}else{_37[_43]=_67.$28x;if(this.getRowSpan){var _70=this.getRowSpan(_63,_61,_1);if(_70>1){var _71=" ROWSPAN="+_70;if(_37[_40]!=null)
_37[_40]+=_71;else
_37[_40]=_71;_54[_1]=_70-1;_55++;_56[_1]=_61;if(_67.$28w==null)_67.$28w={};_67.$28w[_61]=_61}}
if(_36){_37[_48+1]=_67.$28y}else{_37[_48+1]=null}}
var _72=this.getCellStyle(_63,_61,_1),_73=(this.getCellCSSText?this.getCellCSSText(_63,_61,_1):null);if(_62){var _74="padding:0px;border:0px;";if(_73)_73+=";"+_74
else _73=_74}
if(!this.fastCellUpdates){_37[_45]=_73
_37[_46]=_72}else{_37[_45]=isc.Element.getStyleText(_72,true);_37[_45+1]=_73}
if(_62){this.$28q=true;var _75=this.getTableHTML(null,this.$28c,this.$28e);delete this.$28q;if(!_36){_37[_49]=isc.SB.concat(this.$27s,this.$283(_65,_63,_61,_62),this.$ob,this.$oa,_75,"</DIV>")}else{_37[_49]=_75}}else
_37[_49]=this.$22k(_63,_61,_1);if(!_5&&this.getCellElementId){_37[_47]=this.getCellElementId(_61,_61-_2,_1,_1-_13)}
_17.append(_37);if(!_5&&_68!=null&&_68.$29a!=null){if(_68.$29a[0]&&_68.$29a[0].rowNum==null)
{this.updateEmbeddedComponentCoords(_68.$29a,_68,_61,_1)}}
if(_64){if(!_57)break;if(_58>=_1)_1+=_15-
(_63&&_63.$52e)?1:2}}
_17.append(_51);if(_62){_61=this.$28e-1}}}
if(!this.$568||_3==this.getTotalRows())_17.append("</TABLE>");var _76=_7-_3,_77=(!_5&&this.$60s);var _78=this.cacheDOM?0:(this.endSpace||0);this.$515=0;if(!this.showAllRows&&(_76!=0||(_77&&_76==0&&(this.overflow=="auto"||this.overflow=="scroll"))))
{var _79=_76*this.getAvgRowHeight();if(_77&&_76==0){var _80=this.getViewportHeight();if(_79<_80){_79=_80}}
this.$515=_79;_78+=this.$515}
if(!this.cacheDOM&&!this.isPrinting){_17.append("<DIV STYLE='overflow:hidden;width:1px;height:",_78,"px;",(_78==0?"display:none;":null),(_5?"'>":"' ID="+this.getID()+"$284>"),isc.Canvas.spacerHTML(1,_78),"</DIV>")}
if(this.logIsDebugEnabled("gridHTML")){var _81=(isc.timeStamp()-_4),_82=((_14-_13)*(_3-_2)),_83=(_81/ _82),_84=(1000/_83);if(_83.toFixed!=null)_83=_83.toFixed(2);if(_84.toFixed!=null)_84=_84.toFixed(2);this.logDebug("getTableHTML: columns "+_13+"->"+(_14-1)+", rows "+_2+"->"+(_3-1)+", time: "+_81+"ms ("+_82+" cells at "+_83+"ms per cell, "+_84+" cells per second), "+"spacerHeights: ["+[_27,_78]+"], "+_35+" single cell rows","gridHTML")}
return _17.release()}
...
_1.$29b=_1.$nu;_1.$nu=false;_1.$668=_1.bubbleMouseEvents;if(!_1.bubbleMouseEvents)_1.bubbleMouseEvents=false;if(_7&&(_3==-1||_4==-1)){_7=false}
...
_1.$29a.remove(_2);if(_1.$29a.length==0)_1.$29a=null;this.$29a.remove(_2);_2.$nu=_2.$29b;_2.$29b=null;_2.bubbleMouseEvents=_2.$668;var _5=_2.embeddedPosition==this.$57m;_2.embeddedPosition=null;_2.$289=null;_2.$57n=null;_2.$669=null;if(_3){_2.hide();return}
...
);isc.evalBoundary;isc.B.push(isc.A.$29l=function(_1,_2){if((isc.EH.$ku||isc.EH.$km)&&isc.EH.lastEvent.target==this){var _3=this.getEventRow();if(_3!=_1)return true;if(_2!=null){var _4=this.getEventColumn();if(_2!=_4)return true}
return false}
return true}
...
,isc.A.setSelectionAppearance=function(_1,_2){if(this.selectionAppearance==_1&&!_2)return;this.selectionAppearance=_1;if(_1=="checkbox"){this.$65p=this.selectionType;this.setSelectionType(isc.Selection.SIMPLE,true)}else{this.setSelectionType(this.$65p||isc.Selection.MULTIPLE)}
...
,isc.A.dataChanged=function(_1,_2,_3,_4){if(isc.$cv)arguments.$cw=this;this.$67i=true;var _5=this.groupByField;if(_5!=null&&!this.$52y){if(_1=="add"||_1=="remove"||_1=="replace"||(_1=="update"&&(_2==null||_3==null)))
...
if(this.body)this.body.finishRowAnimation();if(!this.$31o)this.$31n();var _14=this.getTotalRows()-1;if(this.body){if(this.body.lastOverRow>_14)delete this.body.lastOverRow;if(this.body.$31p>_14)delete this.body.$31p}
if(this.$31q>_14)delete this.$31q;if(this.hilites)this.applyHilites();if(!this.$50w)this.$25a("dataChanged");delete this.$67i}
,isc.A.$66d=function(_1,_2){var _3=this.$60z();if(_3!=null){var _4=this.getFieldNum(this.sortField),_5=this.getField(_4);if(_5.canSortClientOnly&&!this.$66c(_5)){this.$600(null);if(_3!=null&&this.header&&isc.isA.Toolbar(this.header)){this.header.deselectButton(_3);var _6=this.header.getButton(_3);if(_6)_6.setTitle(this.getHeaderButtonTitle(_6))}
...
var _2=this.$60z(),_3=(_2!=null&&this.fields?this.fields[_2]:null);var _4=this.$30a,_5=this.getEditRow(),_6=this.getEditCol(),_7=this.$286,_8=this.fields?this.getEditFieldName():null;if(this.completeFields==null)this.fields=[];this.completeFields=this.bindToDataSource(_1);if(this.completeFields==null)this.completeFields=[];if(this.selectionAppearance=="checkbox"&&this.selectionType!="none"){var _9=this.getCurrentCheckboxField(),_10=this.getCheckboxFieldPosition(),_11=!_9,_12=this.completeFields.findAll("frozen",true),_13=_12&&(_12.length>1||(_12.length==1&&_12[0][this.fieldIdProperty]!="$63n"));if(_11)_9=this.getCheckboxField();if(_13)_9.frozen=true;else if(_9.frozen)_9.frozen=false;if(_11)this.completeFields.addAt(_9,_10);else this.completeFields.slideList([_9],_10)}
...
,isc.A.getCheckboxField=function(){var _1={width:this.$63g+this.$65a()};isc.addProperties(_1,this.checkboxFieldDefaults,this.checkboxFieldProperties);var _2=this.checkboxFieldFalseImage||this.booleanFalseImage;_1.title=this.selectionType=="single"?" ":this.getValueIconHTML(_2,_1);return _1}
...
,isc.A.prepareForDraw=function(){if(this.completeFields==null)this.setFields(this.fields);if(this.groupByField){var _1;if(isc.isA.Array(this.groupByField)){_1=this.groupByField}else{_1=[this.groupByField]}
this.groupByField=null;this.groupBy(_1)}
this.createChildren()}
);isc.evalBoundary;isc.B.push(isc.A.destroy=function(_1){if(this._dragLine){this._dragLine.destroy();this._dragLine=null}
...
if(_5){if(_5.userFormula)_8=this.getFormulaFieldValue(_5,_1);if(_5.userSummary)this.getSummaryFunction(_5)}
return _8}
...
return _3}
,isc.A.getSpecificFieldValue=function(_1,_2,_3){var _4=this.getRecordIndex(_1),_5=this.getSpecifiedField(_2),_6=this.fields.contains(_5);if(!_5)return;if(_3)return this.getRawCellValue(_1,_4,_2,true);if(_5.userFormula){return this.getFormulaFieldValue(_5,_1)}else if(_5.userSummary){return this.getSummaryFieldValue(_5,_1)}else if(_6){return this.getCellValue(_1,_4,this.getFieldNum(_2),this.body)}
return this.getRawCellValue(_1,_4,_2,true)}
...
,isc.A.getCellAlign=function(_1,_2,_3){if(_1&&_1[this.singleCellValueProperty]!=null&&!this.isCheckboxField(this.getField(_3)))
...
,isc.A.bodyDrawing=function(_1){if(isc.$cv)arguments.$cw=this;var _2;if(this.$31v){_2=!isc.RPCManager.startQueue();this.$67b()}
this.requestVisibleRows();if(_2)isc.RPCManager.sendQueue();this.$31v=null}
,isc.A.$45n=function(){this.$31v=null;var _1=this.$45o;this.$45o={};var _2=this.getDataSource();for(var i=0;i<this.completeFields.length;i++){var _4=this.completeFields[i];if(_4.optionDataSource==null||_4.displayField==null||_4.displayField==_4.valueField||(_4.valueField==null&&_4.displayField==_4[this.fieldIdProperty])||_4.autoFetchDisplayMap==false||(this.autoFetchDisplayMap==false&&_4.autoFetchDisplayMap==null))
{continue}
var _5=isc.DS.get(_4.optionDataSource);if(_5==null){this.logWarn(_4.optionDataSource+" dataSource not found, check value of "+"optionDataSource property on the "+_4[this.fieldIdProperty]+" field");continue}else if(_5==_2){continue}
var _6=_5.ID;if(_1&&_1[_6]!=null){this.$45o[_6]=_1[_6];delete _1[_6];this.$45o[_6].fields=[_4]}else if(this.$45o[_6]!=null){this.$45o[_6].fields.add(_4)}else{this.$45o[_6]={fields:[_4]}
this.$31v=true}}
for(var _7 in this.$45o){if(this.$45o[_7].data!=null){this.$67c(this.$45o[_7].data)}}
if(_1!=null){for(var _8 in _1){if(_1[_8].data)_1[_8].data.destroy()}}}
,isc.A.$67c=function(_1){var _2=_1.getDataSource().getID(),_3=this.$45o[_2]?this.$45o[_2].fields:null;if(_3==null||_3.length==0){this.logWarn("$67c fired for dataSource:"+_2+" which no longer applies to any fields in this ListGrid");return}
for(var i=0;i<_3.length;i++){var _5=_3[i],_6=_5.valueField||_5[this.fieldIdProperty];this.setValueMap(_5[this.fieldIdProperty],_1.getValueMap(_6,_5.displayField))}}
,isc.A.$67b=function(){var _1;for(var _2 in this.$45o){if(this.$45o[_2].data==null){if(_1==null){_1=!isc.RPCManager.startQueue()}
isc.DataSource.getDataSource(_2).fetchData(null,{target:this,methodName:"$317"},{showPrompt:false,clientContext:{optionDS:_2}})}}
if(_1)isc.RPCManager.sendQueue()}
,isc.A.$317=function(_1,_2,_3){var _4=_3.clientContext.optionDS,_5=this.$45o[_4];if(!_5||_5.data!=null)return;_5.data=isc.ResultSet.create({dataSource:_4,targetGrid:this,dataChanged:"this.targetGrid.$67c(this)",initialData:_2})
this.$67c(_5.data);return true}
,isc.A.$67a=function(){if(this.$67d==null)return;for(var _1 in this.$67d){this.$67d[_1].destroy()}
delete this.$67d}
...
,isc.A.$32s=function(_1,_2){var _3=this.$30a;this.$30a=true;if(!this.isDrawn()||!this.body)return;var _4=this.isEmpty()||(!_3&&(_1>=this.data.getLength())&&(this.showNewRecordRow||(this.body.getTableElement(_1)==null)));if(_4||this.body.isDirty()||(this.frozenBody&&this.frozenBody.isDirty())){var _5=this.bodyLayout?this.bodyLayout:this.body;_5.redraw("Showing editor");return}
if(this.editByCell){this.refreshCell(_1,_2)}else{var _6=this.getDrawnFields();for(var i=0;i<_6.length;i++){if(this.isCheckboxField(_6[i]))continue;var _8=_6[i][this.fieldIdProperty],_9=this.$286.getItem(_8),_2=_9.colNum,_10=!!(_3&&_9.isDrawn()),_11=this.canEditCell(_1,_2);if(_10!=_11)this.refreshCell(_1,_2);else if(this.selectOnEdit||this.lastOverRow){var _5=this.getField(_8).frozen?this.frozenBody:this.body;_5.$29h(this.getCellRecord(_1,_2),_1,_2)}}}}
...
return[_3,_4]}
);isc.evalBoundary;isc.B.push(isc.A.$wo=function(_1,_2,_3,_4,_5){if(!_5&&this.confirmDiscardEdits&&this.dataSource!=null){if(this.hasChanges()&&!(isc.ResultSet&&isc.isA.ResultSet(this.data)&&this.data.compareCriteria(_2,this.data.getCriteria())==0))
...
,isc.A.drop=function(){if(this.willAcceptDrop()==false)return false;var _1=this.ns.EH.dragTarget;var _2=this.getDropIndex();var _3=this.getDataSource(),_4=_1.getDataSource();if(_3&&_3==_4){var _5=_1.getDragData()}else{_5=(this.canReorderRecords&&_1==this?this.selection.getSelection():_1.transferDragData?_1.transferDragData():null)}
var _6=this.data.get(_2);if(this.onRecordDrop!=null&&(this.onRecordDrop(_5,_6,_2,_1)==false))
{return false}
return this.recordDrop(_5,_6,_2,_1)}
);isc.evalBoundary;isc.B.push(isc.A.recordDrop=function(_1,_2,_3,_4){this.transferRecords(_1,_2,(this.canReorderRecords?_3:null),_4);if(this.recordsDropped)this.recordsDropped(_1,_3,this,_4);return false}
,isc.A.transferDragData=function(){var _1=this.getDragData();if((isc.isA.ResultTree(this.data)||isc.isA.Tree(this.data))&&(this.dragDataAction==isc.Canvas.COPY||this.dragDataAction==isc.Canvas.CLONE))
...
,isc.A.deriveFrozenFields=function(){var _1=this.frozenFields=this.fields.findAll("frozen",true);var _2=this.completeFields.findAll("frozen",true);if(_1&&_1.length==this.fields.length){_1=this.frozenFields=null;this.$54d=true}else this.$54d=false;if(_1){if(this.selectionAppearance=="checkbox"&&this.selectionType!="none"){var _3=this.getCurrentCheckboxField();if(_3&&!_3.frozen){_3.frozen=true;_1.addAt(_3,this.freezeLeft()?0:this.fields.length);_2.addAt(_3,this.freezeLeft()?0:this.completeFields.length)}}
this.fields.slideList(_1,this.freezeLeft()?0:this.fields.length);this.completeFields.slideList(_2,this.freezeLeft()?0:this.completeFields.length);this.resizeFieldsInRealTime=false}
...
this.endEditing();var _2=this.getCurrentCheckboxField();if(_2){var _3=this.getCheckboxFieldPosition(),_4=this.completeFields.find("frozen",true),_5=_4&&(_4.length>1||(_4.length==1&&_4[0][this.fieldIdProperty]!="$63n"));if(_5)_2.frozen=true;else if(_2.frozen)_2.frozen=false;this.completeFields.slideList([_2],_3)}
this.deriveVisibleFields();this.updateHeader();this.updateBody(_1);this.layoutChildren(this.$60m)}
...
,isc.A.makeHeaderForFields=function(_1,_2,_3){var _4=this.createHeader({ID:_3,grid:this,buttons:_1.duplicate(),reorderOnDrop:false,height:null,minMemberSize:this.minFieldWidth,tabWithinToolbar:false,overflow:_2||"hidden",$nu:!this.fixedFieldWidths})
...
,isc.A.$63m=function(_1){var _2=this.isRTL()?this.fields.length:0,_3=this.fields[_2];if(!this.isCheckboxField(_3))return;var _4=_1?(this.checkboxFieldTrueImage||this.booleanTrueImage):(this.checkboxFieldFalseImage||this.booleanFalseImage),_5=this.selectionType=="single"?" ":this.getValueIconHTML(_4,_3);this.setFieldTitle(_2,_5);_3.$63h=_1}
...
var _3=this.fields[_1];if(this.isCheckboxField(_3)&&this.selectionType!="single"){if(_3.$63h){this.deselectAllRecords();this.$63m(false)}else{this.selectAllRecords();if(!isc.ResultSet||!isc.isA.ResultSet(this.data)||this.data.allMatchingRowsCached()){this.$63m(true)}}
return false}
...
_3.rebuildForFreeze()}})}
return _2}
);isc.evalBoundary;isc.B.push(isc.A.shouldShowColumnPicker=function(_1){if(_1.treeField||this.isCheckboxField(_1))return false;var _2=this.getSummaryTitle(_1);if(_2==null||isc.isAn.emptyString(_2))return false;if(_1.canHide===false)return false;return true}
...
,isc.A.unsort=function(){if(this.data.unsort&&(this.data.unsort()||this.canUnsort)){var _1=this.$60z();this.getField(_1).sortDirection=null;this.sortDirection=isc.ListGrid.getInstanceProperty("sortDirection");this.$600(null);if(_1!=null&&this.header&&isc.isA.Toolbar(this.header)){this.header.deselectButton(_1);var _2=this.header.getButton(_1);if(_2)_2.setTitle(this.getHeaderButtonTitle(_2))}
...
,isc.A.regroup=function(_1){if(!this.isGrouped||(this.canGroupBy==false)||!this.groupByField||!this.groupByField.length||this.inhibitRegroup||!(this.originalData||this.data))
{return}
...
this.groupTree=this.createAutoChild("groupTree",{idField:this.groupIdField,parentIdField:this.groupParentIdField,titleProperty:"groupValue",childrenProperty:"groupMembers",parentProperty:"_groupTree_"+this.ID,showRoot:false,isGroupedOutput:true},isc.Tree);this.logInfo("Adding "+_2.getLength()+" records to groups","grouping");for(var i=0;i<_2.getLength();i++){this.$52u(_2.get(i),false)}
...
);isc.B._maxIndex=isc.C+65;isc.TreeGrid.registerStringMethods({folderOpened:"node",folderClosed:"node",folderClick:"viewer,folder,recordNum",leafClick:"viewer,leaf,recordNum",nodeClick:"viewer,node,recordNum",folderContextClick:"viewer,folder,recordNum",leafContextClick:"viewer,leaf,recordNum",nodeContextClick:"viewer,node,recordNum",dataArrived:"parentNode",onFolderDrop:"nodes,folder,index,sourceWidget"});isc.ClassFactory.defineClass("ButtonStrip","GridRenderer");isc.A=isc.ButtonStrip.getPrototype();isc.A.buttons=[];isc.A.buttonDefaults={};isc.A.buttonSpacing=3;isc.A.buttonPadding=2;isc.A.defaultButtonHeight=20;isc.A.defaultButtonWidth=100;isc.A.vertical=false;isc.A.overflow=isc.Canvas.VISIBLE;isc.A.showRollOver=true;isc.A.useCellRollOvers=true;isc.A.canDrag=false;isc.A.canDragSelect=false;isc.A.canSelectCells=false;isc.A.fastCellUpdates=true;isc.A.titleAlign="center";isc.A.fillSpace=false;isc.A.backgroundColor=null;isc.A.baseStyle="button";isc.A=isc.ButtonStrip.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.initWidget=function(){this.Super(this.$oc);if(this.buttonPadding!=null)this.cellPadding=this.buttonPadding;if(this.buttonSpacing!=null)this.cellSpacing=this.buttonSpacing;var _1=[];for(var i=0;i<this.buttons.length;i++){this.buttons[i]=isc.addProperties({},this.buttonDefaults,this.buttons[i]);if(this.vertical)_1[i]=this.buttons[i].height}
...
_2=isc.DataSource.filterCriteriaForFormValues(_2);var _11={};if(_1)_11.showPrompt=false;var _12=this.sourceWidget.data,_13=this.sourceWidget.autoFetchAsFilter;if(isc.isA.ResultSet(_12)&&_12.willFetchData(_2)){this.fireOnPause("performFilter",{target:this.sourceWidget,methodName:(_13?"filterData":"fetchData"),args:[_2,null,_11]},this.fetchDelay)}else{if(_13){this.sourceWidget.filterData(_2,null,_11)}else{this.sourceWidget.fetchData(_2,null,_11)}}}
...
this.detailViewer=this.createAutoChild("detailViewer",{tileGrid:this,showLabel:this.showLabels,showBorder:false,cellStyle:this.tileValueStyle,labelStyle:this.tileLabelStyle,blockStyle:"normal",wrapValues:this.wrapValues,cellPadding:0,valueAlign:this.tileValueAlign,useInnerWidth:false,clipValues:true,width:10,height:10,dataSource:this.getDataSource(),getCellStyle:function(_2,_3,_4,_5){var _1=(_3.cellStyle||this.cellStyle);if(this.tileGrid.valuesShowRollOver&&this.currentTile.state==isc.StatefulCanvas.STATE_OVER){_1+=this.currentTile.getStateSuffix()}else if(this.tileGrid.valuesShowDown&&this.currentTile.state==isc.StatefulCanvas.STATE_DOWN){_1+=this.currentTile.getStateSuffix()}else if(this.tileGrid.valuesShowSelected&&this.currentTile.isSelected()){_1+=this.currentTile.getStateSuffix()}
...
,isc.A.drop=function(){var _1=this.$610||0;var _2=this.ns.EH.dragTarget;var _3=this.$66f;this.$66f=null;var _4=this.getDataSource(),_5=_2.getDataSource(),_6;if(_4&&_4==_5){_6=_2.getDragData()}else{_6=_2.transferDragData()}
if(_2===this&&_1>_3){_1-=_6.getLength()}
var _7=this.data.get(_1);this.transferRecords(_6,_7,_1,_2)}
...
);isc.B._maxIndex=isc.C+45;isc.ClassFactory.defineClass("SimpleTile","StatefulCanvas");isc.A=isc.SimpleTile.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.baseStyle="simpleTile";isc.A.overflow="hidden";isc.A.showRollOver=true;isc.A.redrawOnStateChange=true;isc.A.$nu=false;isc.B.push(isc.A.initWidget=function(){this.invokeSuper(isc.SimpleTile,"initWidget",arguments);this.showDown=this.creator.valuesShowDown}
...
,isc.A.showHelpWindow=function(){var _1=this.locatorParent,_2=_1?_1.getTop():this.top,_3=_1?_1.getLeft():this.left,_4=_1?_1.getWidth():this.width,_5=_1?_1.getVisibleHeight():this.getVisibleHeight();if(_1)_1.centerInPage();if(this.helpWindow&&this.helpWindow!=null){this.hideHelpWindow()}else{this.helpIcon.prompt=null;this.formulaField.stopHover();if(_1)_1.setLeft(_3-(_4/ 2));this.helpWindow=isc.Window.create({autoDraw:true,title:this.builderTypeText+" Help",showMinimizeButton:false,showMaximizeButton:false,showCloseButton:false,isModal:false,headerIconProperties:{src:"[SKIN]actions/help.png"},items:[isc.Label.create({contents:this.getHelpText(),padding:10})]});this.helpWindow.moveTo(_3+_4,_2);this.helpWindow.resizeTo(_4,_5)}}
...
,isc.A.getSamplePrompt=function(_1){var _2=this.dataSource.getTitleField(),_3=_1.result||"Invalid "+this.builderTypeText,_4=_1.record[_2];return this.samplePrompt.evalDynamicString(this,{title:_4,output:_3})}
...
return _4}
,isc.A.getUsedFieldsFromValue=function(_1,_2,_3){var _4=_1,_5=this.getFieldIdProperty(_3),_6=[];for(var _7 in _4){var _8=_4[_7],_9=_2.findIndex(_5,_8);if(!_2[_9]){isc.logWarn("Field "+_8+" is not in the list of available-fields")}else{var _10=isc.clone(_2[_9]);_10.mappingKey=_7;_6.add(_10)}}
return _6}
...
_5.jsFunction=this.generateFunction(_2,_4,_3);_5.result=_5.jsFunction(_5.record)}catch(err){if(!_5.jsFunction)_5.failedGeneration=true;_5.failedExecution=true;_5.errorText=err.message}
return _5}
...
if(!_4&&_2){_4=[];for(var i=0;i<_2.length;i++){var _7=_2.get(i);if(_7.userFormula){_7.$65w=_7.sortNormalizer=isc.FormulaBuilder.generateFunction(_7.userFormula,_2)}
if(_7.$65w){_4[_7[_3]]=_7.$65w(_4)}else if(_7.type)
