...
<html>
  ...
  <head>
    ...
    <!--                                                               -->
    <link type="text/css" rel="stylesheet" href="/Defbiz.css?version=<%= version%>">
	<link type="text/css" rel="stylesheet" href="/Finance.css?version=<%= version%>">
	<link type="text/css" rel="stylesheet" href="/calendar.css?version=<%= version%>">
	<%
   String app = request.getHeader( "Nativeapp" );
   boolean isNative = ( app != null && !app.equals(""));
   if( isNative ){ %>
   <link type="text/css" rel="stylesheet" href="/native.css?version=<%= version%>">
   <% } %>
...
<div id="hiddenDiv" class="hiddenPic">
	...
	<script type="text/javascript" language="javascript" src="/finance/finance.nocache.js"></script>
