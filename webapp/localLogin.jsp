...
<div class="login clearfix" id="login">
		...
		<div class="loginbox">
		<span><label>Login</label><span id="Import_Account"><a id="import_anchor" href="/importAccount.jsp">Import Account</a></span></span>
     ...
     <option>${account}</option>
		...
		<c:if test="${isLocal!=true}"><a href="/do/forgetpassowrd" target="_top">Forgot password?</a></c:if>
		</div>
		<p>
