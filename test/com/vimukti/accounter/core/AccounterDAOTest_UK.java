...
public class AccounterDAOTest_UK extends
		...
		try {
			...
			if (createSubAccounts) {
				...
				testCallCreateSubAccount("2011", "SubPIR",
						...
						AccounterConstants.PENDING_GOODS_RECEIVED_NOTES, true,
						true, 1000D, dueDate(-1), "Company1");
				testCallCreateSubAccount("2051", "SubSTP",
						Account.TYPE_OTHER_CURRENT_LIABILITY,
						AccounterConstants.SALES_OUTPUT_VAT, true, true, 1000D,
						dueDate(-1), "Company1");
				...
				testCallCreateSubAccount("5101", "SubCDT",
						...
						AccounterConstants.EARLY_PAYMENT_DISCOUNT_TAKEN, true,
						false, 1000D, dueDate(-1), "Company1");
				testCallCreateSubAccount("4101", "SubCDG", Account.TYPE_INCOME,
						AccounterConstants.EARLY_PAYMENT_DISCOUNT_GIVEN, true,
						true, 1000D, dueDate(-1), "Company1");
				...
				if (createMore) {
					...
					testCallCreateSubAccount("4503", "SubSubSubFA",
							Account.TYPE_FIXED_ASSET, "SubSubFA", true, false,
							1000D, dueDate(-1), "Company1");
					testCallCreateSubAccount("3703", "SubSubSubOA",
							Account.TYPE_OTHER_ASSET, "SubSubOA", true, false,
							1000D, dueDate(-1), "Company1");
					testCallCreateSubAccount("2013", "SubSubSubPIR",
							Account.TYPE_OTHER_CURRENT_LIABILITY, "SubSubPIR",
							true, true, 1000D, dueDate(-1), "Company1");
					testCallCreateSubAccount("2053", "SubSubSubSTP",
							Account.TYPE_OTHER_CURRENT_LIABILITY, "SubSubSTP",
							true, true, 1000D, dueDate(-1), "Company1");
					testCallCreateSubAccount("2113", "SubSubSubEPL",
							Account.TYPE_PAYROLL_LIABILITY, "SubSubEPL", true,
							true, 1000D, dueDate(-1), "Company1");
					testCallCreateSubAccount("5503", "SubSubSubLL",
							Account.TYPE_LONG_TERM_LIABILITY, "SubSubLL", true,
							true, 1000D, dueDate(-1), "Company1");
					...
					testCallCreateSubAccount("4103", "SubSubSubCDG",
							Account.TYPE_INCOME, "SubSubCDG", true, true,
							1000D, dueDate(-1), "Company1");
					testCallCreateSubAccount("503", "SubSubSubOI",
							Account.TYPE_OTHER_INCOME, "SubSubOI", true, true,
							1000D, dueDate(-1), "Company1");
					testCallCreateSubAccount("1503", "SubSubSubOE",
							Account.TYPE_OTHER_EXPENSE, "SubSubOE", true,
							false, 1000D, dueDate(-1), "Company1");
				}
	...
	public void testCreateTaxCode() throws DAOException {
		...
		try {
			...
			TaxAgency VATagency = null;
			for (TaxAgency ta : company.getTaxAgencies()) {
				VATagency = ta;
				break;
			}
			taxCode1.setTaxAgency(VATagency);
			taxCode2.setTaxAgency(VATagency);
			taxCode3.setTaxAgency(VATagency);
	...
	public void testCreateItems() throws DAOException {
		...
		if (createItems) {
			...
			items.add(testCallCreateItem(company, true, Item.TYPE_SERVICE,
					"CDG 2000", true, true,
					AccounterConstants.EARLY_PAYMENT_DISCOUNT_GIVEN, 2000.0,
					2000.0, 2l, true, 2000.0,
					AccounterConstants.EARLY_PAYMENT_DISCOUNT_GIVEN));
			items.add(testCallCreateItem(company, true, Item.TYPE_SERVICE,
					"WO 2000", true, true, "Write off", 2000.0, 2000.0, 2l,
					true, 2000.0, "Write off"));
			items.add(testCallCreateItem(company, true, Item.TYPE_SERVICE,
					"CDT 2000", true, true,
					AccounterConstants.EARLY_PAYMENT_DISCOUNT_TAKEN, 2000.0,
					2000.0, 2l, true, 2000.0,
					AccounterConstants.EARLY_PAYMENT_DISCOUNT_TAKEN));
			items.add(testCallCreateItem(company, true, Item.TYPE_SERVICE,
			...
			items.add(testCallCreateItem(company, true, Item.TYPE_SERVICE,
					"STP 2000", true, true,
					AccounterConstants.SALES_OUTPUT_VAT, 2000.0, 2000.0, 2l,
					true, 2000.0, AccounterConstants.SALES_OUTPUT_VAT));
			items.add(testCallCreateItem(company, true, Item.TYPE_SERVICE,
					"PIR 2000", true, true,
					AccounterConstants.PENDING_GOODS_RECEIVED_NOTES, 2000.0,
					2000.0, 2l, true, 2000.0,
					AccounterConstants.PENDING_GOODS_RECEIVED_NOTES));
			items.add(testCallCreateItem(company, true, Item.TYPE_SERVICE,
