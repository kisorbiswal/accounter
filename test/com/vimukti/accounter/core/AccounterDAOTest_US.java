...
import com.vimukti.accounter.core.BalanceSheetReport;
...
import com.vimukti.accounter.core.ReportList;
...
public class AccounterDAOTest_US extends
		TestCase {

	IAccounterService accounter=null;
	...
	createCashSales = true, createInvoices = true,
			createCustomerCreditMemos = true, createCustomerRefunds = true,
			createEnterBills = true, createVendorCreditMemos = true,
			createCashPurchases = true, createWriteChecks = false,
			createMakeDeposits = false, createReceivePayments = false,
			createPayBills = false, createVendorPayments = false,
			createCreditCardCharges = true, createTransferFunds = false,
			...
			voidMakeDeposits = true, voidReceivePayments = true,
			...
			checkBalanceSheet = false, checkCustomerTransactionHistory = false,
	...
	//		
	// // List<MostProfitableCustomers> mostProfitableCustomers =
	// accounterReportDAOService.getMostProfitableCustomers(company.getId(),
	// startDate, endDate);
	// //
	// // List<MostProfitableCustomers> profitabilityByCustomerDetailReport =
	// accounterReportDAOService
	// .getProfitabilityByCustomerDetail(company.getId(),6L,startDate, endDate);
	//		
	// List<TrialBalance> profitAndLossReport =
	// accounterReportDAOService.getProfitAndLossReport(company.getId(),
	// startDate, endDate);
	// new WriteToPDF(profitAndLossReport);
	//		
	// }
	...
	public void testCreateCashAccount() throws Exception {
		...
		cash.setAsOf(format.parse(today()));
	...
	public void testCreateBankAccount() throws DAOException, ParseException {
		...
		bank.setAsOf(format.parse(today()));
		OCA.setAsOf(format.parse(today()));
		OA.setAsOf(format.parse(today()));
		LL.setAsOf(format.parse(today()));
		OE.setAsOf(format.parse(today()));
		FA.setAsOf(format.parse(today()));
		IA.setAsOf(format.parse(today()));
		OI.setAsOf(format.parse(today()));
	...
	public void testCallCreateSubAccount(String num, String name, int type,
		...
		acc.setAsOf(format.parse(today()));
	...
	public void testCreateSubAccount() throws Exception {
		...
		try {
			...
			if (createSubAccounts) {
				...
				testCallCreateSubAccount("4101", "SubCDG", Account.TYPE_INCOME,
	...
	//
	// Company company = accounterDao.getCompany(1l, 1l);
	...
	public void testCreateTaxCode() throws DAOException {
		...
		try {
			...
			try {
				...
				taxRates1_1.setAsOf(format.parse(dueDate(0)));
				taxRates2_1.setAsOf(format.parse(dueDate(0)));
				taxRates3_1.setAsOf(format.parse(dueDate(0)));
	...
	public CashSales testCallCreateCashSales(CashSales cs, String cu, long cm,
		...
		cs.setDepositIn(accounterDao.getAccount(cm,
	...
	public void testCreateItems() throws DAOException {
		...
		if (createItems) {
			items.add(testCallCreateItem(company, true,
					...
					"Un Deposited Funds", 2000d, 1000d, 1l, true, 2000d,
					"Un Deposited Funds"));
			items.add(testCallCreateItem(company, true,
					Item.TYPE_NON_INVENTORY_PART, "OCA 2000", true, true,
					"Account OCA", 2000.0, 100.0, 1l, true, 2000.0,
					"Account OCA"));
			items
					.add(testCallCreateItem(company, true,
							Item.TYPE_NON_INVENTORY_PART, "OA 2000", true,
							true, "Account OA", 2000.0, 200.0, 1l, true,
							2000.0, "Account OA"));
			items.add(testCallCreateItem(company, true,
					Item.TYPE_NON_INVENTORY_PART, "ACC 2000", true, true,
					"Account Credit Card", 300.0, 2000.0, 1l, true, 2000.0,
					"Account Credit Card"));
			items
					.add(testCallCreateItem(company, true,
							Item.TYPE_NON_INVENTORY_PART, "OE 2000", true,
							true, "Account OE", 2000.0, 400.0, 1l, true,
							2000.0, "Account OE"));
			items.add(testCallCreateItem(company, true,
					Item.TYPE_NON_INVENTORY_PART, "AC 2000", true, true,
					"Account Cash", 2000.0, 500.0, 1l, true, 2000.0,
					"Account Cash"));
			items
					.add(testCallCreateItem(company, true,
							Item.TYPE_NON_INVENTORY_PART, "LL 2000", true,
							true, "Account LL", 2000.0, 600.0, 1l, true,
							2000.0, "Account LL"));
			items.add(testCallCreateItem(company, true, Item.TYPE_SERVICE,
					"EPL 2000", true, true, "Employee Payroll Liabilities",
					2000.0, 700.0, 2l, true, 2000.0,
					"Employee Payroll Liabilities"));
			items.add(testCallCreateItem(company, true, Item.TYPE_SERVICE,
					"OB 2000", true, true, "Opening Balances", 2000.0, 800.0,
					2l, true, 2000.0, "Opening Balances"));
			items.add(testCallCreateItem(company, true, Item.TYPE_SERVICE,
					"RE 2000", true, true, "Retained Earnings", 2000.0, 900.0,
					2l, true, 2000.0, "Retained Earnings"));
			items.add(testCallCreateItem(company, true, Item.TYPE_SERVICE,
					"CDG 2000", true, true, "Cash Discount Given", 2000.0,
					1000.0, 2l, true, 2000.0, "Cash Discount Given"));
			items.add(testCallCreateItem(company, true, Item.TYPE_SERVICE,
					"WO 2000", true, true, "Write off", 2000.0, 1000.0, 2l,
					true, 2000.0, "Write off"));
			items.add(testCallCreateItem(company, true, Item.TYPE_SERVICE,
					"CDT 2000", true, true, "Cash Discount taken", 2000.0,
					3000.0, 2l, true, 2000.0, "Cash Discount taken"));
			items.add(testCallCreateItem(company, true, Item.TYPE_SERVICE,
					"BC 2000", true, true, "Bank Charge", 2000.0, 4000.0, 2l,
					true, 2000.0, "Bank Charge"));
			items.add(testCallCreateItem(company, true, Item.TYPE_SERVICE,
					"OI 2000", true, true, "Account OI", 2000.0, 5000.0, 2l,
					true, 2000.0, "Account OI"));
			items.add(testCallCreateItem(company, true, Item.TYPE_SERVICE,
					"STP 2000", true, true, "Sales Tax Payable", 2000.0,
					6000.0, 2l, true, 2000.0, "Sales Tax Payable"));
			items.add(testCallCreateItem(company, true, Item.TYPE_SERVICE,
					"PIR 2000", true, true, "Pending Item Receipts", 2000.0,
					7000.0, 2l, true, 2000.0, "Pending Item Receipts"));
			items.add(testCallCreateItem(company, true, Item.TYPE_SERVICE,
					"AB 2000", true, true, "Account Bank", 2000.0, 8000.0, 2l,
					true, 2000.0, "Account Bank"));
			items.add(testCallCreateItem(company, true, Item.TYPE_SERVICE,
					"FA 2000", true, true, "Account FA", 2000.0, 9000.0, 2l,
		...
		if (checkTesting) {
			...
			while (i.hasNext() && j.hasNext()) {
				...
				// assertEquals(a.getCompany().getName(),
	...
	public void testCreateCustomerCreditMemo() throws Exception {
		...
		if (createCustomerCreditMemos) {
			...
			transactionItems1.add(testCallCreateTransactionItem(company
					.getName(), TransactionItem.TYPE_ACCOUNT, 1D, 1000D, true,
					AccounterConstants.OPENING_BALANCE, creditMemo1));
			transactionItems2.add(testCallCreateTransactionItem(company
					.getName(), TransactionItem.TYPE_ACCOUNT, 1D, 1000D, true,
					"Bank Charge", creditMemo2));
			if (creditMemo1 != null) {
	...
	// public void testFiscalYear() throws Exception {
	// Date startDate = format.parse("2006-08-08");
	// company = accounterDao.getCompany(1L);
	...
	public CustomerRefund testCallCreateCustomerRefunds(long cm, String payTo,
			...
			String paymentmethod, long checkno) throws Exception {
	...
	public void testCreateCustomerRefunds() throws Exception {
		...
		if (createCustomerRefunds) {
			...
			cfs
					.add(testCallCreateCustomerRefunds(1l, "Customer1",
							getRandomPayFromAccount(payFromAccounts).getName(),
							1000d, today(), 0d,
							AccounterConstants.PAYMENT_METHOD_CASH, 1111l));
			cfs
					.add(testCallCreateCustomerRefunds(1l, "Customer2",
							getRandomPayFromAccount(payFromAccounts).getName(),
							1000d, today(), 0d,
			...
			cfs.add(testCallCreateCustomerRefunds(1l, "Customer3",
					...
					1111l));
			cfs
					.add(testCallCreateCustomerRefunds(1l, "Customer4",
							getRandomPayFromAccount(payFromAccounts).getName(),
							1000d, today(), 0d,
							AccounterConstants.PAYMENT_METHOD_CASH, 1111l));
			cfs
					.add(testCallCreateCustomerRefunds(1l, "Customer5",
							getRandomPayFromAccount(payFromAccounts).getName(),
							1000d, today(), 0d,
							AccounterConstants.PAYMENT_METHOD_CHECK, 1112l));
			...
			if (createMore) {
				...
				cfs.add(testCallCreateCustomerRefunds(1l, "Customer3",
						getRandomPayFromAccount(payFromAccounts).getName(),
						1000d, today(), 0d,
						AccounterConstants.PAYMENT_METHOD_CHECK, 1113l));
	...
	public CashPurchase testCallCreateCashPurchase(long cm, String vendor,
		...
		cp.setPayFrom(accounterDao.getAccount(1L,
				AccounterConstants.UN_DEPOSITED_FUNDS));
	...
	public void testCallCreateWriteCheck(String cm, String date, String bank,
		...
		w.setBankAccount(accounterDao.getAccount(accounterDao.getCompany(1L)
				.getId(), AccounterConstants.UN_DEPOSITED_FUNDS));
	...
	public WriteCheck testCallCreateWriteCheckTaxAgency(String cm, String date,
		...
		TaxAgency taxAgency = accounterDao.getTaxAgency(company.getId(), w
				.getTaxAgency().getId());
		accounter.createWriteCheck(w);
		if (checkTesting)
			assertEquals(taxAgency.getName(), taxAgency.getBalance()
					- w.getTotal(), accounterDao.getTaxAgency(company.getId(),
	...
	public void testCreateWriteChecks() throws Exception {
		...
		if (createWriteChecks) {
			...
			// TaxAgency ta = agencies.get(new
			// Random().nextInt(agencies.size()));
			TaxAgency ta = agencies.get(2);
	...
	public TransactionMakeDeposit testCallCreateTransactionItem(
		...
		long id = getLongIdForGivenStringId(AccounterCoreType.TRANSACTION, md
				.getTransactionId());
		...
		if (createMakeDeposits) {
			...
			for (int n = 0; n < customers.size(); n++)
				entries1.add(testCallCreateNewTransactionCustomer(1l,
						...
						// customers.get(new
						// Random().nextInt(customers.size())).getName(),
						"Customer1", 1000d, makeDeposit1));

			for (int n = 0; n < vendors.size(); n++)
				entries2.add(testCallCreateNewTransactionVendor(1l,
						TransactionMakeDeposit.TYPE_VENDOR,
						// vendors.get(new
						// Random().nextInt(vendors.size())).getName(),
						"Vendor1", 1000d, makeDeposit2));
	...
	public CreditCardCharge testCallCreateCreditCardCharge(CreditCardCharge cs,
		...
		cs.setPayFrom(accounterDao.getAccount(cm,
				AccounterConstants.UN_DEPOSITED_FUNDS));
		cs.setTransactionItems(ti);
	...
	public PaySalesTax testCallCreatePaySalesTax(Company company, String date,
		...
		paySalesTax.setPayFrom(accounterDao.getAccount(company.getId(),
				AccounterConstants.UN_DEPOSITED_FUNDS));
	...
	public void testTrailBalance() throws DAOException, ParseException {
		...
		if (checkTrialBalance) {
			...
			while (i.hasNext()) {
				...
				// System.out.println("Account =" + tb.getAccountName() +
				// " id ="
