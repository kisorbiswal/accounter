...
public interface SessionManager {
	...
	/**
	 * Creates a url connection setting any appropriate headers including
	 * cookies
	 * 
	 * @param url
	 *            The url
	...
	/**
	 * Called after a request is made to handle any response headers including
	 * cookies. The response data from the connection shouldn't be read.
	 * 
	 * @param connection
	 *            The connection
	 */
