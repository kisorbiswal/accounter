...
public class EmployeeDetail implements IAccounterServerCore, Lifecycle,
		ICreatableObject {
	...
	public boolean canEdit(IAccounterServerCore clientObject)
		...
		Query query = session.getNamedQuery("getEmployeeDetails").setParameter(
				"name", this.employeeName).setParameter("number",
				this.employeeNumber).setParameter("id", this.id);
	...
	public boolean onDelete(Session arg0) throws CallbackException {
		FinanceLogger.log("Employee with Name {0} has been deleted", this
				.getEmployeeName());
