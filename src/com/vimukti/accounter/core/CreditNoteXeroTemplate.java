...
public class CreditNoteXeroTemplate implements PrintTemplete {
	...
	public CreditNoteXeroTemplate(CustomerCreditMemo memo,
	...
	public String getPdfData() {
		...
		try {
			...
			try {
				...
				String customernameAddress = forUnusedAddress(memo
						.getCustomer().getName(), false);
				Address bill = memo.getBillingAddress();
				if (bill != null) {
					customernameAddress = "<div align=\"left\">&nbsp;"
							+ forUnusedAddress(memo.getCustomer().getName(),
									false)
