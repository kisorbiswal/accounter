 ...
 * 
 * The Employee Category options can also be used to track the salaries paid to
 * the Employees working in specific projects or locations. e.g. Head Office and
 * Regional Offices.
 * 
