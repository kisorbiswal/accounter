 ...
 * 
 */
public class InvoiceQuickBookPdf implements PrintTemplete {
	...
	public InvoiceQuickBookPdf(Invoice invoice, BrandingTheme brandingTheme,
	...
	public String getPdfData() {
		...
		try {
			...
			String dueAmt = largeAmountConversation(invoice.getBalanceDue());
			if (dueAmt.trim().length() > 0) {
				t.setVariable("amountDue", dueAmt);

			}

			// for setting enclosed value
			// t.setVariable("enclosed", "");

			t.setVariable("VATRate", "Tax Rate");
			t.setVariable("VATAmount", "Tax Amount");
