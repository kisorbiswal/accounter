...
public class CompanyTypeCommand extends AbstractCommand {
	...
	public Result run(Context context) {
		...
		if (selection == null) {
			makeResult
					.add("Select “Start Setup” to enter the Setup wizard to add all the necessary information for company or else skip this wizard and add later.");
