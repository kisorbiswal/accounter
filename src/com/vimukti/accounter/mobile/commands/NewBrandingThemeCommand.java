...
public class NewBrandingThemeCommand extends NewAbstractCommand {
	...
	// private static final String OVERDUE_INVOICE_TITLE =
	// "Overdue Invoice Title";
	...
	// private static final String SHOW_COLUMN_HEADINGS =
	// "Show Column Headings";
	// private static final String SHOW_UNITPRICE_N_QUANTITY =
	...
	// private static final String TERMS_N_PAYMENT_ADVICE =
	...
	// }
	//
	// private Result getBottomMarginRequirement(Context context, ResultList
	// list,
	// Object selection) {
