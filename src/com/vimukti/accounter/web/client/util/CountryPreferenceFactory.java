...
public class CountryPreferenceFactory {
	...
	public static String[] countries = new String[] { UNITED_KINGDOM,
			...
			MEXICO, MICRONESIA_FEDERATED, MOLDOVA, MONACO, MONGOLIA,
			MONTSERRAT, MOROCCO, MOZAMBIQUE, NAMIBIA, NAURU, NEPAL,
			NETHERLANDS, NETHERLANDS_ANTILLES, NEW_CALEDONIA, NEW_ZEALAND,
			NICARAGUA, NIGER, NIGERIA, NIUE, NORFOLK_ISLAND,
			NORTHERN_MARIANA_ISLANDS, NORWAY, OMAN, PAKISTAN, PALAU, PANAMA,
			PAPUA_NEW_GUINEA, PARAGUAY, PERU, PHILIPPINES, PITCAIRN_ISLANDS,
			POLAN, PORTUGAL, PUERTO_RICO, QATAR, REUNION, ROMANIA, RUSSIA,
