...
public interface AccounterMessages extends Messages {
	...
	public String accandaccumulatedDepreciationAccShouldnotbesame(String account);
	...
	public String accounterCategoryList(String account);
	...
	public String accountReceivable(String account);

	public String accountRegister(String account);

	public String Accounts();

	public String accountsSelected(String account);

	public String accountToDebitForSale(String account);
	...
	public String accumulatedDepreciationAccount(String account);
	...
	public String addANewVendorPayment(String vendor);

	public String addBank();

	public String addBankAccount(String account);
	...
	public String addMore(String transactions);

	public String addNew(String transactionName);
	...
	public String adjustmentAccount(String account);
	...
	public String allTransactionDetails(String account);

	public String aLocationAlreadyExistswiththisname();

	public String alreadyAccountExist(String account);
	...
	public String amountDueToVendor(String vendor);
	...
	public String amountReceivedWithCurrencyName(String currencyCode);
	...
	public String bankAccountInformation(String account);

	public String bankAccountNo(String account);

	public String bankAccountNumber(String account);

	public String bankAccountType(String account);
	...
	public String billPaidSoYouCantEdit();

	public String billPaidSoYouCantVoid();
	...
	public String billstrackingdescription(String accounts);
	...
	public String cannotUsePurchaseItem(String account);

	public String cannotUseSalesItem(String account);

	public String cantbeAfterEnd();

	public String cantearlierThanStart();

	public String cantEdit();

	public String cantentermorethat100();

	public String cantenternegnumber();

	public String cantVoid();
	...
	public String cashBackAccount(String account);
	...
	public String cashFlowCategory(String account);
	...
	public String changePayees(String payee);
	...
	public String chartOfAccounts(String account);

	public String chartOfAccountsInformation(String account);
	...
	public String clickThisObjToOpen(String objType, String transactionName);

	public String clickThisTo(String function, String transactionName);

	public String clickThisToOpen(String transactionName);
	...
	public String companySettingsTitle();
	...
	public String conversionAccount(String account);
	...
	public String createanyadditionalbankaccounts(String account);
	...
	public String creating(String transactionName);
	...
	public String creditCardAccountInformation(String account);
	...
	public String currencyTotal(String currencyCode);
	...
	public String depositedFromUndepositedFunds();
	...
	public String depreciationAccount(String account);
	...
	public String discountAccount(String account);
	...
	public String expenseAccount(String account);
	...
	public String failedtogetAccountReceivablechartvalues(String account);

	public String failedtogetBankaccountchartvalues(String account);

	public String failedTogetCreditsListAndPayments(String payeeName);

	public String failedtogetExpensetotals();

	public String failedtoGetListofAccounts(String accounts,
			String takenAccountName);

	public String failedtogetmoneygoingportletvalues();

	public String failedToGetPurchaseOrder();

	public String failedToGetRecievePayments(String transactionName);
	...
	public String failedToLoadCustomerHome(String payee);

	public String failedtoloadEmployeeslist();

	public String failedtoloadusersList();

	public String failedToLoadVendorsHome(String payee);
	...
	public String failedTransaction(String transactionName);
	...
	public String fromAccount(String account);
	...
	public String getSalesByLocationDetails(String location);
	...
	public String giveOpeningBalanceToThis(String payee);

	public String giveTheNameAccordingToYourID(String transactionName);

	public String gotoAccounter();

	public String goToAccountReceivable(String account);

	public String goToAccountsPayable(String account);
	...
	public String hasSelected(String requirement);
	...
	public String howIsYourCompanyOrganizedDesc(String accounts);
	...
	public String incomeAccount(String account);

	public String incomeandDistribution();

	public String incomeAndExpenseAccounts(String account);
	...
	public String itemsDash(String name);
	...
	public String logoComment1();

	public String logoComment2();

	public String logoComment3();

	public String logoComment4();

	public String logoComment5();
	...
	public String makeDepositCashBackAccount(String account);
	...
	public String manageCustomerGroup(String customer);
	...
	public String manageVendorGroup(String vendor);
	...
	public String mergeAccounts(String account);

	public String mergeCustomers(String customer);

	public String mergeDescription(String account);

	public String mergeFinancialAccounts(String account);
	...
	public String newBankAccount(String account);
	...
	public String newPayee(String payee);
	...
	public String noBillsAreAvailableFirstAddABill(String payee);

	public String nocompany();

	public String noCreditsforthiscustomer(String customer);

	public String noCreditsForThisVendor(String vendor);
	...
	public String panNumber(String account);
	...
	public String payeeAddress(String payee);

	public String payeeBalance(String payee);
	...
	public String payeeID(String payee);

	public String payeeInformation(String payee);

	public String payeeInUse(String payee);
	...
	public String payeePrePayment(String payee);

	public String payees(String payee);
	...
	public String payeeTerminology(String payee);

	public String payeeTo(String payee);

	public String payeeTransactionHistory(String payee);
	...
	public String phoneNumberOf(String payee);

	public String pleaseChooseAnAccount(String account);
	...
	public String pleaseSelectPayFromAccount(String account);
	...
	public String pleaseSelectThePayee(String payee);

	public String pleaseselectvaliddateranges();

	public String pleaseselectvalidtransactionGrid(String transactionType);
	...
	public String preferredVendor(String vendor);
	...
	public String purchaseByVendorDetail(String vendor);

	public String purchaseByVendorSummary(String vendor);
	...
	public String purchaseLiabilityAccount(String account);
	...
	public String receivePaymentDiscountUsed();
	...
	public String reviewIncomeAndExpensesAccounts(String account);
	...
	public String salesByCustomerDetail(String customer);

	public String salesByCustomerSummary(String customer);

	public String salesByItemDetail();

	public String salesByItemSummary();

	public String salesByLocationSummary(String location);
	...
	public String salesLiabilityAccount(String account);
	...
	public String selectAccountType(String account);
	...
	public String selectDateOfHire(String salesperson);

	public String selectDateUntilDue(String transactionName);

	public String selectDateWhenTransactioCreated(String transactionName);
	...
	public String selectedTranslated(String languageName);

	public String selectFirstMonthOfFiscalYear();

	public String selectFor(String taxCode, String transactionName);
	...
	public String selectPaymentMethod(String account);
	...
	public String setupComplitionDesc();
	...
	public String shouldBePositive(String amount);

	public String shouldNotbeZero(String amount);
	...
	public String showAllAccounts(String accounts);
	...
	public String taxAccount(String account);
	...
	public String taxAgencyFinanceAcount(String account);
	...
	public String theFinanceCategoryNoShouldBeBetween(String account);

	public String theFinanceCategoryNoShouldBeBetween1100And1179(String account);

	public String themenamealreadyexist();

	public String thereAreNo(String recordType);
	...
	public String thisIsConsideredACashAccount(String account);
	...
	public String toAccount(String account);
	...
	public String totalWithCurrencyName(String totalType);

	public String toTransferFunds(String account);
	...
	public String transactionConflict();

	public String transactionDate();

	public String transactionDetailByAccount(String account);

	public String transactionDetailByTaxCode();

	public String transactionDetailByTaxItem();

	public String transactionDetailsByAccount(String account);
	...
	public String unableToGet(String objType);
	...
	public String unusedCreditsWithCurrencyName(String currencyCode);

	public String unusedPayments(String currencyCode);
	...
	public String updateSuccessfully(String transactionName);
	...
	public String useAccountNos(String account);
	...
	public String usedinInvoiceSoYoucantEdit();

	public String usePayeeId(String payee);
	...
	public String vendorProductNo(String vendor);

	public String vendorsAndPayables(String vendor);

	public String vendorsBelowThreshold(String vendor);

	public String vendorServiceNo(String vendor);
	...
	public String writeCommentsForThis(String transactionName);

	public String writeOff();

	public String writeOffAccount(String account);
	...
	public String youcannotchangeaCustomertypetoVendortype(String customer,
			String vendor);
	...
	public String youCantEdit(String transactionName);
	...
	public String youDontHaveAny(String recordName);
