...
public class AccounterDateTimeFormatInfoImpl extends DateTimeFormatInfoImpl {
	...
	@Override
	public native String[] erasFull() /*-{		
		return $wnd['accounter_locale']['erasFull'];
	}-*/;

	@Override
	public native String[] erasShort() /*-{
	...
	@Override
	public native String[] monthsFull() /*-{
		
		return $wnd['accounter_locale']['monthsFull'];
	}-*/;

	@Override
	public native String[] monthsFullStandalone() /*-{
		
		return $wnd['accounter_locale']['monthsFullStandalone'];
	}-*/;

	@Override
	public native String[] monthsNarrow() /*-{
		
		return $wnd['accounter_locale']['monthsNarrow'];
	}-*/;

	@Override
	public native String[] monthsNarrowStandalone() /*-{
	...
	@Override
	public native String[] monthsShortStandalone() /*-{
		
		return $wnd['accounter_locale']['monthsShortStandalone'];
	}-*/;

	@Override
	public native String[] quartersFull() /*-{
		
		return $wnd['accounter_locale']['quartersFull'];
	}-*/;

	@Override
	public native String[] quartersShort() /*-{
	...
	@Override
	public native String[] weekdaysFull() /*-{
		
		return $wnd['accounter_locale']['weekdaysFull'];
	}-*/;

	@Override
	public native String[] weekdaysFullStandalone() /*-{
		
		return $wnd['accounter_locale']['weekdaysFullStandalone'];
	}-*/;

	@Override
	public native String[] weekdaysNarrow() /*-{
		
		return $wnd['accounter_locale']['weekdaysNarrow'];
	}-*/;

	@Override
	public native String[] weekdaysNarrowStandalone() /*-{
	...
	@Override
	public native String[] weekdaysShortStandalone() /*-{
