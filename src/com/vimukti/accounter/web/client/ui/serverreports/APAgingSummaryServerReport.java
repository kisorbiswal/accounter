...
public class APAgingSummaryServerReport extends
	...
	public APAgingSummaryServerReport(long startDate, long endDate,int generationType) {
	...
	public String[] getColunms() {
		...
		return new String[] { "Creditor", "0-30 Days", "31-60 Days",
				"61-90 Days", "Older", "Total Balance" };
	}

	@Override
	public String getTitle() {
		return "A/P Ageing Summary:";
	}
