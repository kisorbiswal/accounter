...
public class TransactionDetailByAccountServerReport extends
	...
	public TransactionDetailByAccountServerReport(
	...
	public void makeReportRequest(long start, long end) {
		...
		//
		// onSuccess(this.financeTool.getTransactionDetailByAccount(start,
		// end));
		// } else {
		// onSuccess(this.financeTool.getTransactionDetailByAccount(
