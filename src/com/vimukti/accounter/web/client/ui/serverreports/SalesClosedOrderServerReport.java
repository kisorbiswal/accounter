...
public class SalesClosedOrderServerReport extends
		AbstractFinaneReport<OpenAndClosedOrders> {

	private String sectionName;

	public SalesClosedOrderServerReport(
			IFinanceReport<OpenAndClosedOrders> reportView) {
		this.reportView = reportView;
	}

	public SalesClosedOrderServerReport(long startDate, long endDate,int generationType) {
	...
	public String[] getColunms() {
		return new String[] { "Order Date", "Customer", "Description",
				"Quantity", "Value" };
	}

	@Override
	public String getTitle() {
		return "Sales Close Order";
	}
	...
	public void makeReportRequest(long start, long end) {
		...
		// resetVariables();
		// try {
		// onSuccess(this.financeTool.getClosedSalesOrders(start, end));
