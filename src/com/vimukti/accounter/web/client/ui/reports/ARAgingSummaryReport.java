...
public class ARAgingSummaryReport extends AbstractReportView<DummyDebitor> {
	...
	public void OnRecordClick(DummyDebitor record) {
		...
		UIUtils.runAction(record, ReportsActionFactory.getArAgingDetailAction());
	...
	public void makeReportRequest(ClientFinanceDate start, ClientFinanceDate end) {
		...
		Accounter.createReportService().getDebitors(start.getTime(),
	...
	public void print() {
		...
		UIUtils.generateReportPDF(
				...
				Integer.parseInt(String.valueOf(endDate.getTime())), 117, "",
				"");
	}
