...
public class GettingStartedPortlet extends DashBoardPortlet {
	...
	public void createBody() {
		...
		// <li> <a href=''><font color='green'>Watch the Getting StartedR
		// tour.</font></a>
		...
		// throughout the year.
		minHtml = new HTML(
				"<p>Now you are ready to start using Accounter on a regular basis to record and report on normal business transcations. There is <a href=''><font color='green'>full online help</font></a> and tips on each screen in Accounter if you need it. It's really up to you what you do next.</p><ul><li>Add <a href=''><font color='green'>accounts receivable </font></a>and <a href=''><font color='green'>accounts payable </font></a>invoices, <a href=''><font color='green'>bank transactions </font></a>and <a href=''><font color='green'>expense claims.</font></a><li>Add to <a href=''><font color='green'>customers</font></a> or <a href=''><font color='green'>suppliers</font></a> the people you regularly transact with.</ul>");
		allHtml = new HTML(
