...
public class CoreUtils {
	...
	private static ClientLanguage[] languages = new ClientLanguage[] {
			...
			new ClientLanguage("Armenian", "Հայերեն", "ARM"),
			new ClientLanguage("Azeri", "Azərbaycan dili", "AZE"),
			new ClientLanguage("Basque", "Euskara", "BAQ"),
			new ClientLanguage("Belarusian", "Беларуская", "BEL"),
			new ClientLanguage("Bengali", "বাংলা", "BEN"),
			new ClientLanguage("Bosnian", "Bosanski", "BOS"),
			new ClientLanguage("Bulgarian", "Български", "BUL"),
			new ClientLanguage("Catalan", "Català", "CAT"),
			new ClientLanguage("Croatian", "Hrvatski", "HRV"),
			new ClientLanguage("Czech", "Čeština", "CZE"),
			new ClientLanguage("Danish", "Dansk", "DAN"),
			new ClientLanguage("Dutch", "Nederlands", "DUT"),
			new ClientLanguage("Español (España)", "Español (España)", "ESP"),
			new ClientLanguage("Esperanto", "Esperanto", "EPO"),
			new ClientLanguage("Estonian", "Eesti", "EST"),
			new ClientLanguage("Faroese", "Føroyskt", "FAO"),
			new ClientLanguage("Filipino", "Filipino", "FIL"),
			new ClientLanguage("Finnish", "Suomi", "FIN"),
			new ClientLanguage("Français (Canada)", "Français (Canada)",
					"FRA_C"),
			new ClientLanguage("Français France", "Français France", "FRA_F"),
			new ClientLanguage("Frisian", "Frisian", "FR"),
			new ClientLanguage("Galician", "Galego", "GLG"),
			new ClientLanguage("Georgian", "ქართული", "GEO"),
			new ClientLanguage("German", "Deutsch", "GER"),
			new ClientLanguage("Greek", "Ελληνικά", "GRE"),
			new ClientLanguage("Haitian Creole", "Kreyòl", "HAT"),
			new ClientLanguage("Hebrew", "‏עברית‏", "HEB"),
			new ClientLanguage("Hindi", "हिन्दी", "HIN"),
			new ClientLanguage("Hungarian", "Magyar", "HUN"),
			new ClientLanguage("Icelandic", "Íslenska", "ICE"),
			new ClientLanguage("Indonesian", "Bahasa Indonesia", "IND"),
			new ClientLanguage("Irish", "Gaeilge", "GLE"),
			new ClientLanguage("Italian", "Italiano", "ITA"),
			new ClientLanguage("Japanese", "日本語", "JPN"),
			new ClientLanguage("Korean", "한국어", "KOR"),
			new ClientLanguage("Kurdish", "Kurdî", "KUR"),
			new ClientLanguage("Latin", "lingua latina", "LAT"),
			new ClientLanguage("Latvian", "Latviešu", "LAV"),
			new ClientLanguage("Leet", "Speak", "LEE"),
			new ClientLanguage("Lithuanian", "Lietuvių", "LIT"),
			new ClientLanguage("Macedonian", "Македонски", "MAC"),
			new ClientLanguage("Malay", "Bahasa Melayu", "MAY"),
			new ClientLanguage("Malayalam", "മലയാളം", "MAL"),
			new ClientLanguage("Maltese", "Maltese", "MLT"),
			new ClientLanguage("Nepali", "नेपाली", "NEP"),
			new ClientLanguage("Norwegian (bokmal)", "Norsk (bokmål)", "NOB"),
			new ClientLanguage("Norwegian (nynorsk)", "Norsk (nynorsk)", "NNO"),
			new ClientLanguage("Pashto", "‏پښتو‏", "PUS"),
			new ClientLanguage("Persian", "‏فارسی‏", "PER"),
			new ClientLanguage("Polish", "Polski", "POL"),
			new ClientLanguage("Português (Brasil)", "Português (Brasil)",
					"POR_B"),
			new ClientLanguage("Português (Portugal)", "Português (Portugal)",
					"POR_P"),
			new ClientLanguage("Punjabi", "ਪੰਜਾਬੀ", "PAN"),
			new ClientLanguage("Romanian", "Română", "RUM"),
			new ClientLanguage("Russian", "Русский", "RUS"),
			new ClientLanguage("Serbian", "Српски", "SRP"),
			new ClientLanguage("Simplified Chinese (China)", "中文(简体)", "CHI_S"),
			new ClientLanguage("Slovak", "Slovenčina", "SLO"),
			new ClientLanguage("Slovenian", "Slovenščina", "SWA"),
			new ClientLanguage("Swahili", "Kiswahili", ""),
			new ClientLanguage("Swedish", "Svenska", "SWE"),
			new ClientLanguage("Tamil", "தமிழ்", "TAM"),
			new ClientLanguage("Telugu", "తెలుగు", "TEL"),
			new ClientLanguage("Thai", "ภาษาไทย", "THA"),
			new ClientLanguage("Traditional Chinese (Taiwan)", "中文(台灣)", "CHI"),
			new ClientLanguage("Traditional Chinese(Hong Kong)", "中文(香港)",
					"ZHO"), new ClientLanguage("Turkish", "Türkçe", "TUR"),
			new ClientLanguage("Ukrainian", "Українська", "UKR"),
			new ClientLanguage("Urdu", "اردو", "URD"),
			new ClientLanguage("Vietnamese", "Tiếng Việt", "VIE"),
			new ClientLanguage("Welsh", "Cymraeg", "WEL"),
			new ClientLanguage("Yiddish", "ייִדיש", "YID"), };
	private static String[] countries = new String[] { "Afghanistan",
			"Albania", "Algeria", "AmericanSamoa", "Andorra", "Angola",
			"Anguilla", "Antarctica", "AntiguaandBarbuda", "Argentina",
			"Armenia", "Aruba", "Australia", "Austria", "Azerbaijan",
			"Bahamas,The", "Bahrain", "Bangladesh", "Barbados", "Belarus",
			"Belgium", "Belize", "Benin", "Bermuda", "Bhutan", "Bolivia",
			"BosniaandHerzegovina", "Botswana", "BouvetIsland", "Brazil",
			"BritishIndianOceanTerritory", "Brunei", "Bulgaria", "BurkinaFaso",
			"Burundi", "Cambodia", "Cameroon", "Canada", "CapeVerde",
			"CaymanIslands", "CentralAfricanRepublic", "Chad", "Chile",
			"China", "ChristmasIsland", "Cocos(Keeling)Islands", "Colombia",
			"Comoros", "Congo,DemocraticRepublicofthe", "Congo,Republicofthe",
			"CookIslands", "CostaRica", "Coted'Ivoire", "Croatia", "Cuba",
			"Cyprus", "CzechRepublic", "Denmark", "Djibouti", "Dominica",
			"DominicanRepublic", "Ecuador", "Egypt", "ElSalvador",
			"EquatorialGuinea", "Eritrea", "Estonia", "Ethiopia",
			"FalklandIslands(IslasMalvinas)", "FaroeIslands", "Fiji",
			"Finland", "France", "FrenchGuiana", "FrenchPolynesia",
			"FrenchSouthernandAntarcticLands", "Gabon", "Gambia,The",
			"Georgia", "Germany", "Ghana", "Gibraltar", "Greece", "Greenland",
			"Grenada", "Guadeloupe", "Guam", "Guatemala", "Guinea",
			"Guinea-Bissau", "Guyana", "Haiti",
			"HeardIslandandMcDonaldIslands", "HolySee(VaticanCity)",
			"Honduras", "HongKong", "Hungary", "Iceland", "India", "Indonesia",
			"Iran", "Iraq", "Ireland", "IsleofMan", "Israel", "Italy",
			"Jamaica", "JanMayen", "Japan", "Jordan", "Kazakhstan", "Kenya",
			...
			"Mayotte", "Mexico", "Micronesia,FederatedStatesof", "Moldova",
			"Monaco", "Mongolia", "Montserrat", "Morocco", "Mozambique",
			"Namibia", "Nauru", "Nepal", "Netherlands", "NetherlandsAntilles",
			"NewCaledonia", "NewZealand", "Nicaragua", "Niger", "Nigeria",
			"Niue", "NorfolkIsland", "NorthernMarianaIslands", "Norway",
			"Oman", "Pakistan", "Palau", "Panama", "PapuaNewGuinea",
			"Paraguay", "Peru", "Philippines", "PitcairnIslands", "Poland",
			"Portugal", "PuertoRico", "Qatar", "Reunion", "Romania", "Russia",
			"Rwanda", "SaintHelena", "SaintKittsandNevis", "SaintLucia",
			"SaintPierreandMiquelon", "SaintVincentandtheGrenadines", "Samoa",
			"SanMarino", "SaoTomeandPrincipe", "SaudiArabia", "Senegal",
			"SerbiaandMontenegro", "Seychelles", "SierraLeone", "Singapore",
			"Slovakia", "Slovenia", "SolomonIslands", "Somalia", "SouthAfrica",
			"SouthGeorgiaandtheSouthSandwichIslands", "Spain", "SriLanka",
			...
			"Uzbekistan", "Vanuatu", "Venezuela", "Vietnam", "VirginIslands",
	...
	private static ClientCurrency[] currencies = new ClientCurrency[] {
			...
			new ClientCurrency("Afghan Afghani", "AFN", "؋"),
			...
			new ClientCurrency("Bosnia Mark", "BAM", "KM"),
			new ClientCurrency("Botswana Pula", "BWP", "P"),
			...
			new ClientCurrency("Ghanaian Cedi", "GHS", "¢"),
			...
			new ClientCurrency("Lebanese Pound", "LBP", "£"),
			...
			new ClientCurrency("Syrian Pound", "SYP", "Â£S"),
	 ...
	 * "Congolese  Franc", "Congolese  Franc", "Costa Rican  ColÃ³n",
	 ...
	 * "Hong Kong  Dollar", "Hungarian  Forint", "Icelandic  KrÃ³na",
	 ...
	 * "New Zealand  Dollar", "Nicaraguan  CÃ³rdoba", "Nigerian  Naira",
	 * "Norwegian  Krone", "Omani  Rial", "Pakistani  Rupee",
	 * "Panamanian  Balboa", "Papua New Guinean  Kina", "Paraguayan  GuaranÃ­",
	 * "Peruvian Nuevo  Sol", "Philippine  Peso", "Qatari  Riyal",
	 * "Romanian  Leu", "Russian  Ruble", "Rwandan  Franc",
	 * "Saint Helenian  Pound", "Samoan  Tala",
	 * "SÃ£o TomÃ© and PrÃ­ncipe  Dobra", "Saudi  Riyal", "Serbian  Dinar",
	 ...
	 * "Taiwanese New  Dollar", "Tajikistani  Somoni", "Tanzanian  Shilling",
	 * "Thai  Baht", "Tongan  Pa?anga", "Trinidad and Tobago  Dollar",
	 * "Tunisian  Dinar", "Turkmenistani  Manat", "Turkish  Lira",
	 * "Ugandan  Shilling", "Ukrainian  Hryvnia",
	 * "United Arab Emirates  Dirham", "Uruguayan  Peso", "Uzbekistani  Som",
	 * "Vanuatu  Vatu", "Venezuelan BolÃ­var  Fuertes", "Vietnamese  Dong",
	 * "Yemeni  Rial", "Zambian  Kwacha", "Zimbabwean  Dollar", "Danish Krone"
	 * };
	 * 
	...
	public static List<ClientLanguage> getLanguages() {
		List<ClientLanguage> languagesList = new ArrayList<ClientLanguage>();
