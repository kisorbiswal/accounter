...
public class AccounterMenuBar extends HorizontalPanel {
	...
	/*
	 * private IMenuBar getMenuBar() { IMenuBar menuBar =
	 * factory.createMenuBar();
	 * 
	 ...
	 * ThemesUtil.insertImageChildToMenuItem(menuBar, menuitem); } //
	 * menuBar.addItem(messages.help(), // getHelpMenu()); if
	 * (Accounter.getUser().canChangeSettings()) {
	 * menuBar.addMenuItem(messages.settings(), getSettingsMenu()); //
	 * ThemesUtil.insertImageChildToMenuItem(menuBar, menuitem); }
	 * 
	 * return menuBar; }
	 * 
	 * private IMenu getInventoryMenu() { IMenu inventoryMenuBar =
	 * factory.createMenu(); //
	 ...
	 * getInventoryListsMenu()); return inventoryMenuBar; }
	 * 
	 * private IMenu getInventoryListsMenu() { IMenu inventoryMenu =
	 * factory.createMenu();
	 * inventoryMenu.addMenuItem(messages.inventoryItems(),
	 * ActionFactory.getInventoryItemsAction()); if
	 * (getPreferences().iswareHouseEnabled()) {
	 ...
	 * ActionFactory.getMeasurementsAction()); return inventoryMenu; }
	 * 
	 * private IMenu getNewInventoryMenu() {
	 * 
	 * IMenu newMenuBar = factory.createMenu(); if
	 * (getPreferences().iswareHouseEnabled()) {
	 ...
	 * ActionFactory.getAddMeasurementAction()); return newMenuBar;
	 * 
	 * }
	 * 
	 * private IMenu getTaxMenu() { IMenu taxMenu = getSubMenu();
	 * 
	 * taxMenu = getVATMenu(); return taxMenu; }
	 * 
	 * private IMenu getSettingsMenu() { IMenu settingsMenuBar =
	 * factory.createMenu();
	 * settingsMenuBar.addMenuItem(ActionFactory.getGeneralSettingsAction());
	 * settingsMenuBar.addMenuItem(ActionFactory.getTranslationAction()); return
	 * settingsMenuBar; }
	 * 
	 * private IMenu getFixedAssetsMenu() { IMenu fixedAssetMenu =
	 * factory.createMenu();
	 ...
	 * 
	 * private IMenu getVATMenu() { IMenu vatmenu = getSubMenu();
	 * 
	 * IMenu vatNews = getSubMenu(); if
	 ...
	 * vatmenu.addItem(ActionFactory.getCreateTaxesAction()); if
	 * (Accounter.getUser().canDoBanking()) {
	 ...
	 * vatmenu.addSeparatorItem(); // if (preferences.isTDSEnabled()) { //
	 ...
	 * return vatmenu; }
	 * 
	 * private IMenu getTDSMenu() { IMenu tdsMenu = getSubMenu();
	 * tdsMenu.addMenuItem("TDS Return",
	 * ActionFactory.getTDSVendorsAction(true)); tdsMenu.addMenuItem("Form-16A",
	 * ActionFactory.getTDSVendorsAction(false)); return tdsMenu; }
	 * 
	 * private IMenu getVATsListMenu() { IMenu vatmenus = getSubMenu();
	 * vatmenus.addMenuItem(ActionFactory.getVatItemListAction());
	 * vatmenus.addMenuItem(ActionFactory.getTAXCodeListAction());
	 * vatmenus.addMenuItem(ActionFactory.getTAXAgencyListAction()); return
	 * vatmenus; }
	 * 
	 * private IMenu getFixedAssetsListMenu() { IMenu fixedAssetListMenu =
	 * getSubMenu(); fixedAssetListMenu.addMenuItem(ActionFactory
	 * .getPendingItemsListAction());
	 * fixedAssetListMenu.addMenuItem(ActionFactory
	 * .getRegisteredItemsListAction());
	 * 
	 * fixedAssetListMenu.addMenuItem(ActionFactory
	 * .getSoldDisposedListAction()); return fixedAssetListMenu; }
	 * 
	 * private IMenu getHelpMenu() { IMenu helpMenuBar = getSubMenu(); //
	 * helpMenuBar.addItem(messages.help(), // new Command() { // public void
	 * execute() { // Window.alert("Not implemented yet!"); // } // }); //
	 * helpMenuBar.addItem(ActionFactory.getFinanceLogAction()); return
	 * helpMenuBar; }
	 * 
	 * private IMenu getReportMenu() { IMenu reportMenuBar = getSubMenu();
	 * 
	 ...
	 * getCompanyAndFinancialMenu()); reportMenuBar.addMenuItem(
	 ...
	 * reportMenuBar.addMenuItem( Global.get().messages()
	 * .vendorsAndPayables(Global.get().Vendors()), getVendorAndPayablesMenu());
	 * reportMenuBar.addMenuItem(messages.purchase(), getPurchaseMenu());
	 * 
	 * reportMenuBar.addMenuItem(messages.budget(), getBudgetSubMenus());
	 * 
	 * // reportMenuBar.addItem(messages.budget() + " " // + messages.report(),
	 * getBudgetSubMenus()); // if (Accounter.getCompany().getAccountingType()
	 * == // ClientCompany.ACCOUNTING_TYPE_US) { //
	 * reportMenuBar.addItem(messages // .banking(), getBankingSubMenu()); // }
	 * if (Accounter.getCompany().getPreferences().isTrackTax()) {
	 * reportMenuBar.addMenuItem(messages.tax(), getVATReportMenu()); } //
	 * reportMenuBar.addItem(messages // .salesAndPurchaseOrders(),
	 * getSalesAndPurchaseMenu()); return reportMenuBar; }
	 * 
	 * private IMenu getSalesSubMenu() { IMenu salesMenu = getSubMenu(); if
	 * (Accounter.getUser().canDoInvoiceTransactions())
	 * salesMenu.addMenuItem(ActionFactory.getSalesOrderAction()); if
	 * (Accounter.getUser().canSeeInvoiceTransactions())
	 * salesMenu.addMenuItem(ActionFactory.getSalesOrderListAction()); if
	 * (Accounter.getUser().canViewReports())
	 * salesMenu.addMenuItem(ActionFactory.getSalesOpenOrderAction()); return
	 * salesMenu; }
	 * 
	 * private IMenu getPurchaseSubMenu() { IMenu purchaseMenu = getSubMenu();
	 * if (Accounter.getUser().canDoInvoiceTransactions())
	 * purchaseMenu.addMenuItem(ActionFactory.getPurchaseOrderAction()); if
	 * (Accounter.getUser().canSeeInvoiceTransactions()) purchaseMenu
	 * .addMenuItem(ActionFactory.getPurchaseOrderListAction()); if
	 * (Accounter.getUser().canViewReports())
	 * purchaseMenu.addMenuItem(ActionFactory
	 * .getPurchaseOpenOrderListAction()); return purchaseMenu; }
	 * 
	 * private IMenu getVendorAndPayablesMenu() { IMenu vendorAndPayableMenuBar
	 * = getSubMenu(); vendorAndPayableMenuBar.addMenuItem(ActionFactory
	 ...
	 * true, 0)); vendorAndPayableMenuBar.addMenuItem(ActionFactory
	 * .getVendorTransactionHistoryAction()); //
	 * vendorAndPayableMenuBar.addItem(ActionFactory //
	 * .getAmountsDueToVendorsAction()); return vendorAndPayableMenuBar; }
	 * 
	 * private IMenu getBudgetSubMenus() { IMenu budgetMenu = getSubMenu();
	 * 
	 ...
	 * 
	 * // vendorAndPayableMenuBar.addItem(ActionFactory //
	 * .getAmountsDueToVendorsAction()); return budgetMenu; }
	 * 
	 * private IMenu getPurchaseMenu() { IMenu purchaseMenuBar = getSubMenu();
	 ...
	 * 
	 * if (getPreferences().isPurchaseOrderEnabled()) {
	 * purchaseMenuBar.addMenuItem(ActionFactory .getPurchaseOpenOrderAction());
	 * } return purchaseMenuBar; }
	 * 
	 * private IMenu getVATReportMenu() { IMenu vatReportMenuBar = getSubMenu();
	 * ICountryPreferences countryPreferences = Accounter.getCompany()
	 * .getCountryPreferences(); if (countryPreferences instanceof UnitedKingdom
	 * && countryPreferences.isVatAvailable()) {
	 * vatReportMenuBar.addMenuItem(ActionFactory .getVATSummaryReportAction());
	 * vatReportMenuBar.addMenuItem(ActionFactory .getVATDetailsReportAction());
	 ...
	 * else { vatReportMenuBar.addMenuItem(ActionFactory
	 ...
	 * 
	 * private IMenu getSalesMenu() { IMenu salesMenuBar = getSubMenu();
	 * salesMenuBar.addMenuItem(ActionFactory
	 * .getSalesByCustomerSummaryAction()); salesMenuBar
	 ...
	 * 
	 * if (getPreferences().isSalesOrderEnabled()) {
	 * salesMenuBar.addMenuItem(ActionFactory.getSalesOpenOrderAction()); } if
	 * (Accounter.getCompany().getPreferences().isLocationTrackingEnabled()) {
	 * salesMenuBar.addMenuItem(ActionFactory
	 ...
	 * salesMenuBar.addMenuItem(ActionFactory
	 * .getSalesByLocationSummaryAction(false)); } return salesMenuBar; }
	 * 
	 * private IMenu getCustomersAndReceivableMenu() { IMenu
	 * customersAndReceivableMenuBar = getSubMenu();
	 ...
	 * 
	 * private IMenu getCompanyAndFinancialMenu() { IMenu
	 * companyAndFinancialMenuBar = getSubMenu();
	 * companyAndFinancialMenuBar.addMenuItem(ActionFactory
	 * .getProfitAndLossAction());
	 * companyAndFinancialMenuBar.addMenuItem(ActionFactory
	 * .getBalanceSheetAction()); // if
	 ...
	 * .getGlReportAction());
	 * companyAndFinancialMenuBar.addMenuItem(ActionFactory
	 * .getExpenseReportAction()); if
	 * (Accounter.getCompany().getPreferences().isTrackTax()) {
	 * companyAndFinancialMenuBar.addMenuItem(ActionFactory
	 * .getSalesTaxLiabilityAction()); } if
	 * (Accounter.getCompany().getPreferences().isTrackTax()) {
	 * companyAndFinancialMenuBar.addMenuItem(ActionFactory
	 * .getTransactionDetailByTaxItemAction()); } if
	 * (Accounter.getCompany().getPreferences().isLocationTrackingEnabled())
	 * companyAndFinancialMenuBar.addMenuItem(ActionFactory
	 * .getProfitAndLossByLocationAction(true)); if
	 * (Accounter.getCompany().getPreferences().isClassTrackingEnabled())
	 * companyAndFinancialMenuBar.addMenuItem(ActionFactory
	 * .getProfitAndLossByLocationAction(false)); return
	 * companyAndFinancialMenuBar; }
	 * 
	 * private IMenu getBankingMenu() { IMenu bankingMenuBar = getSubMenu(); //
	 ...
	 * bankingMenuBar.addItem(ActionFactory.getAccountRegisterAction()); // if
	 * (Accounter.getCompany().getAccountingType() == //
	 * ClientCompany.ACCOUNTING_TYPE_US)
	 ...
	 * bankingMenuBar.addItem(ActionFactory.getTransferFundsAction()); if
	 * (Accounter.getCompany().getPreferences().isKeepTrackofBills())
	 ...
	 * bankingMenuBar.addSeparatorItem(); bankingMenuBar
	 ...
	 * 
	 * private IMenu getBankingListMenu() { IMenu bankingListMenuBar =
	 * getSubMenu(); // bankingListMenuBar.addItem(ActionFactory //
	 * .getChartsOfAccountsAction());
	 * bankingListMenuBar.addMenuItem(ActionFactory
	 * .getPaymentsAction(PaymentsAction.BANKING)); ChartOfAccountsAction
	 * chartOfAccountsAction = new ChartOfAccountsAction(
	 * messages.bankAccounts(), ClientAccount.TYPE_BANK);
	 * bankingListMenuBar.addMenuItem(chartOfAccountsAction); return
	 * bankingListMenuBar; }
	 * 
	 * private IMenu getVendorMenu() { IMenu vendorMenuBar = getSubMenu();
	 ...
	 * vendorMenuBar.addSeparatorItem(); if
	 * (Accounter.getUser().canDoInvoiceTransactions()) if
	 * (Accounter.getCompany().getPreferences().isKeepTrackofBills())
	 * vendorMenuBar.addMenuItem(ActionFactory.getEnterBillsAction()); if
	 * (Accounter.getUser().canDoBanking()) { if
	 * (Accounter.getCompany().getPreferences().isKeepTrackofBills())
	 * vendorMenuBar.addMenuItem(ActionFactory.getPayBillsAction()); if
	 * (Accounter.getCompany().getPreferences().isKeepTrackofBills())
	 * vendorMenuBar.addMenuItem(ActionFactory .getIssuePaymentsAction());
	 * vendorMenuBar .addMenuItem(ActionFactory.getNewVendorPaymentAction()); }
	 * if (Accounter.getUser().canDoInvoiceTransactions()) {
	 ...
	 * vendorMenuBar.addMenuItem(ActionFactory .getExpenseClaimsAction(0)); } //
	 * vendorMenuBar.addItem(ActionFactory.getItemReceiptAction());
	 * vendorMenuBar.addSeparatorItem(); } vendorMenuBar.addMenuItem(
	 * Global.get().messages().payeeLists(Global.get().Vendor()),
	 * getVendorListMenu()); return vendorMenuBar; }
	 * 
	 * private IMenu getVendorListMenu() { IMenu vendorListMenuBar =
	 * getSubMenu();
	 * vendorListMenuBar.addMenuItem(ActionFactory.getVendorsAction()); if
	 * (Accounter.getUser().canSeeInvoiceTransactions()) { ItemsAction
	 * itemsAction = ActionFactory.getItemsAction(false, true);
	 * itemsAction.setCatagory(Global.get().vendor());
	 * vendorListMenuBar.addMenuItem(itemsAction); if
	 * (Accounter.getCompany().getPreferences().isKeepTrackofBills())
	 * vendorListMenuBar.addMenuItem(ActionFactory.getBillsAction()); } if
	 * (Accounter.getUser().canSeeBanking())
	 * vendorListMenuBar.addMenuItem(ActionFactory .getVendorPaymentsAction());
	 * 
	 * return vendorListMenuBar; }
	 * 
	 * private IMenu getNewVendorMenu() { IMenu newVendorMenuBar = getSubMenu();
	 * if (Accounter.getUser().canDoInvoiceTransactions()) {
	 * newVendorMenuBar.addMenuItem(ActionFactory.getNewVendorAction());
	 * newVendorMenuBar.addMenuItem(ActionFactory.getNewItemAction(false)); } if
	 * (Accounter.getUser().canDoBanking())
	 * newVendorMenuBar.addMenuItem(ActionFactory .getNewCashPurchaseAction());
	 * if (Accounter.getUser().canDoInvoiceTransactions()) newVendorMenuBar
	 * .addMenuItem(ActionFactory.getNewCreditMemoAction()); if
	 * (Accounter.getUser().canDoInvoiceTransactions())
	 * newVendorMenuBar.addMenuItem(ActionFactory.getNewCheckAction());
	 * 
	 * return newVendorMenuBar; }
	 * 
	 * private IMenu getCustomerMenu() { IMenu customerMenuBar = getSubMenu();
	 ...
	 * customerMenuBar.addSeparatorItem(); if
	 * (Accounter.getUser().canDoBanking()) {
	 * customerMenuBar.addMenuItem(ActionFactory
	 * .getNewCustomerPaymentAction()); customerMenuBar
	 * .addMenuItem(ActionFactory.getReceivePaymentAction()); customerMenuBar
	 * .addMenuItem(ActionFactory.getCustomerRefundAction());
	 * customerMenuBar.addSeparatorItem(); } customerMenuBar.addMenuItem(
	 * messages.payeeLists(Global.get().Customer()), getCustomerListMenu());
	 * return customerMenuBar; }
	 * 
	 * private IMenu getCustomerListMenu() { IMenu customerListMenuBar =
	 * getSubMenu();
	 * customerListMenuBar.addMenuItem(ActionFactory.getCustomersAction()); if
	 * (Accounter.getUser().canSeeInvoiceTransactions()) { ItemsAction
	 * itemsAction = ActionFactory.getItemsAction(true, false);
	 * itemsAction.setCatagory(Global.get().Customer());
	 * customerListMenuBar.addMenuItem(itemsAction); if
	 * (preferences.isDoyouwantEstimates()) {
	 * customerListMenuBar.addMenuItem(ActionFactory.getQuotesAction(
	 * messages.quotes(), ClientEstimate.QUOTES)); } if
	 * (preferences.isDelayedchargesEnabled()) {
	 * customerListMenuBar.addMenuItem(ActionFactory.getQuotesAction(
	 * messages.Charges(), ClientEstimate.CHARGES));
	 * customerListMenuBar.addMenuItem(ActionFactory.getQuotesAction(
	 * messages.credits(), ClientEstimate.CREDITS)); }
	 * customerListMenuBar.addMenuItem(ActionFactory .getInvoicesAction(null));
	 * 
	 ...
	 * 
	 * private IMenu getNewCustomerMenu() { IMenu newCustomerMenuBar =
	 * getSubMenu(); if (Accounter.getUser().canDoInvoiceTransactions()) {
	 * newCustomerMenuBar .addMenuItem(ActionFactory.getNewCustomerAction());
	 * newCustomerMenuBar .addMenuItem(ActionFactory.getNewItemAction(true)); if
	 * (preferences.isDoyouwantEstimates()) {
	 * newCustomerMenuBar.addMenuItem(ActionFactory.getNewQuoteAction(
	 * ClientEstimate.QUOTES, messages.newQuote())); } if
	 * (preferences.isDelayedchargesEnabled()) {
	 * newCustomerMenuBar.addMenuItem(ActionFactory.getNewQuoteAction(
	 * ClientEstimate.CHARGES, messages.newCharge()));
	 * newCustomerMenuBar.addMenuItem(ActionFactory.getNewQuoteAction(
	 * ClientEstimate.CREDITS, messages.newCredit())); }
	 * newCustomerMenuBar.addMenuItem(ActionFactory.getNewInvoiceAction()); } if
	 * (Accounter.getUser().canDoBanking()) newCustomerMenuBar
	 * .addMenuItem(ActionFactory.getNewCashSaleAction()); if
	 * (Accounter.getUser().canDoInvoiceTransactions())
	 ...
	 * 
	 * private IMenu getSubMenu() { return factory.createMenu(); }
	 * 
	...
	/*
	 * private Command getDashBoardCommand() { Command dashBoardcmd = new
	 * Command() {
	 * 
	 * @Override public void execute() {
	 * ActionFactory.getCompanyHomeAction().run(null, false); } }; return
	 * dashBoardcmd; }
	 * 
	 ...
	 * ActionFactory.getSearchInputAction()); companyMenuBar.addSeparatorItem();
	 * 
	 * if (Accounter.getUser().canDoBanking()) companyMenuBar
	 * .addMenuItem(ActionFactory.getNewJournalEntryAction()); if
	 * (Accounter.getUser().canDoInvoiceTransactions()) {
	 * companyMenuBar.addMenuItem(ActionFactory.getNewAccountAction());
	 * companyMenuBar.addSeparatorItem(); } //
	 * companyMenuBar.addItem(ActionFactory // .getCompanyInformationAction());
	 * if (Accounter.getUser().canChangeSettings()) { PreferencesAction.CATEGORY
	 ...
	 * companyMenuBar.addSeparatorItem();
	 * 
	 * if (getPreferences().isTrackTax()) { companyMenuBar
	 * .addMenuItem(messages.itemTax(), getSalesTaxSubmenu()); } if
	 * (Accounter.getUser().canChangeSettings()) {
	 * companyMenuBar.addMenuItem(messages.manageSupportLists(),
	 * getManageSupportListSubmenu()); companyMenuBar.addSeparatorItem(); } //
	 ...
	 * 
	 * private IMenu getMergeSubMenu() { IMenu mergeAccountsMenuBar =
	 * getSubMenu(); // mergeAccountsMenuBar.addMenuItem( //
	 * messages.mergeCustomers(Global.get().Customer()), //
	 ...
	 * 
	 * private IMenu getCompanyListMenu() { IMenu companyListMenuBar =
	 * getSubMenu(); if (Accounter.getUser().canSeeInvoiceTransactions())
	 * companyListMenuBar.addMenuItem(ActionFactory
	 * .getChartOfAccountsAction()); if (Accounter.getUser().canSeeBanking())
	 * companyListMenuBar.addMenuItem(ActionFactory .getJournalEntriesAction());
	 * if (Accounter.getUser().canSeeInvoiceTransactions()) { ItemsAction
	 * itemsAction = ActionFactory.getItemsAction(true, true);
	 ...
	 * companyListMenuBar.addMenuItem(ActionFactory.getVendorsAction()); if
	 * (Accounter.getUser().canSeeBanking())
	 * companyListMenuBar.addMenuItem(ActionFactory
	 ...
	 * 
	 * private IMenu getManageSupportListSubmenu() { IMenu
	 * manageSupportListMenuBar = getSubMenu();
