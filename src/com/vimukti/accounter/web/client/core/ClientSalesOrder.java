...
// salesOrder.shippingAdress = this.shippingAdress.clone();
//
// List<ClientTransactionIssuePayment> transactionIssuePayments = new
// ArrayList<ClientTransactionIssuePayment>();
// for (ClientTransactionIssuePayment clientTransactionIssuePayment :
// this.transactionIssuePayment) {
// transactionIssuePayments.add(clientTransactionIssuePayment.clone());
// }
// salesOrder.transactionIssuePayment = transactionIssuePayments;
//
// List<ClientTransactionItem> transactionItems = new
...
// salesOrder.transactionItems = transactionItems;
//
// List<ClientTransactionPayBill> transactionPayBills = new
// ArrayList<ClientTransactionPayBill>();
// for (ClientTransactionPayBill clientTransactionPayBill :
// this.transactionPayBill) {
// transactionPayBills.add(clientTransactionPayBill.clone());
// }
// salesOrder.transactionPayBill = transactionPayBills;
//
// List<ClientTransactionPayTAX> transactionPaySalesTaxs = new
// ArrayList<ClientTransactionPayTAX>();
// for (ClientTransactionPayTAX clientTransactionPaySalesTax :
// this.transactionPaySalesTax) {
// transactionPaySalesTaxs.add(clientTransactionPaySalesTax.clone());
// }
// salesOrder.transactionPaySalesTax = transactionPaySalesTaxs;
//
// List<ClientTransactionReceivePayment> transactionReceivePayments = new
// ArrayList<ClientTransactionReceivePayment>();
// for (ClientTransactionReceivePayment clientTransactionReceivePayment :
