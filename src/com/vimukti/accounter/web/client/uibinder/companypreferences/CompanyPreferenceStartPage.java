...
public class CompanyPreferenceStartPage extends Composite implements HasText {
	...
	interface CompanyPreferenceStartPageUiBinder extends
			UiBinder<Widget, CompanyPreferenceStartPage> {
	}

	public CompanyPreferenceStartPage() {
	...
	public CompanyPreferenceStartPage(String firstName) {
		initWidget(uiBinder.createAndBindUi(this));
