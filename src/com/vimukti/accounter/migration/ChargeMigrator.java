...
public class ChargeMigrator extends TransactionMigrator<Estimate> {
	@Override
	public JSONObject migrate(Estimate obj, MigratorContext context)
		...
		jsonObj.put("quotationType",
				PicklistUtilMigrator.getQuotationTypeIdentifier(1));
		...
		// splitting
		String childKey = "transactionItems-SalesQuotationItem";
